...
DEVICE_CX732Q_N_PATH = '/usr/share/sonic/device/x86_64-asterfusion_cx732q_n-r0/CX732Q-N/'
CONFIG_DB_TMP_PATH = '/tmp/config_db.json'
CONFIG_DB_PATH = '/etc/sonic/config_db.json'
YAML_PATH = DEVICE_CX732Q_N_PATH + 'config_32x100G_asterfusion-cx732q-n.yaml'
YAML_TMP_PATH = '/tmp/config_32x100G_asterfusion-cx732q-n.yaml'
MOD_FILE_ERR = -1
...
#CONFIG_32X100G_ASTERFUSION-CX732Q-N.YAML
