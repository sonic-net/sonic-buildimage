...
DEVICE_CX664D_N_PATH = '/usr/share/sonic/device/x86_64-asterfusion_cx664d_n-r0/CX664D-N/'
CONFIG_DB_TMP_PATH = '/tmp/config_db.json'
CONFIG_DB_PATH = '/etc/sonic/config_db.json'
YAML_PATH = DEVICE_CX664D_N_PATH + 'config_64x200G_asterfusion-cx664d-n.yaml'
YAML_TMP_PATH = '/tmp/config_64x200G_asterfusion-cx664d-n.yaml'
MOD_FILE_ERR = -1
...
#CONFIG_64X200G_ASTERFUSION-CX664D-N.YAML
