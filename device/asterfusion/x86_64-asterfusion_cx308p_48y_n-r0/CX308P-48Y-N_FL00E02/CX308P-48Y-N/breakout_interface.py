...
DEVICE_CX308P_PATH = '/usr/share/sonic/device/x86_64-asterfusion_cx308p_48y_n-r0/CX308P-48Y-N/'
CONFIG_DB_TMP_PATH = '/tmp/config_db.json'
CONFIG_DB_PATH = '/etc/sonic/config_db.json'
falcon_2T_48x25_8x100_port_profile_PATH = DEVICE_CX308P_PATH + 'falcon_2T_48x25_8x100_port_profile'
PLATFORM_INI_PATH = DEVICE_CX308P_PATH + 'platform.ini_bak'

MOD_FILE_ERR = -1

# CONFIG_DB_PATH = 'config_db.json'
# CONFIG_DB_TMP_PATH = 'config_db_tmp.json'
# falcon_2T_48x25_8x100_port_profile_PATH = 'falcon_2T_48x25_8x100_port_profile'
# PLATFORM_INI_PATH= 'platform.ini'
# YAML_PATH = '48x25G_8x100G.yaml'
# YAML_TMP_PATH = '48x25G_8x100G_tmp.yaml'
...
with open(falcon_2T_48x25_8x100_port_profile_PATH, 'w') as To_C:
...
with open(PLATFORM_INI_PATH, 'r') as pt:
    ...
    for k, v in cur_cfg['PORT'].items():
        ...
        if k >= 48 and k < 60 and k % 4 == 0:
            ...
            continue
    with open(DEVICE_CX308P_PATH + "platform.ini", 'w') as pt_tmp:
