...
class fan_tlv():
    ...
    VERSION = 0x01                       # The version number defined in the E2PROM file, initially 0x01
    FLAG = 0x7E                       # The new version E2PROM is identified as 0x7E
    HW_VER = 0X01                       # It consists of two parts: the main version number and the revised version
    ...
    def generate_fan_value(self):
        ...
        crcs = fan_tlv.fancrc(''.join(bin_buffer[0:index_start]))  # 2 byte check
