...
CEL_DS5001_PLATFORM_MODULE_VERSION = 1.0
...
export CEL_DS5001_PLATFORM_MODULE_VERSION
...
CEL_DS5001_PLATFORM_MODULE = platform-modules-ds5001_$(CEL_DS5001_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_DS5001_PLATFORM_MODULE)_PLATFORM = x86_64-cls_ds5001-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_DS5001_PLATFORM_MODULE)))
