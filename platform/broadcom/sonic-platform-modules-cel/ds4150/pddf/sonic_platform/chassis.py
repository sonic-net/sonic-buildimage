...
class Chassis(PddfChassis):
    ...
    def get_status_led(self):
        ...
        try:
            ...
            helper_logger.log_error(f"Failed to get status LED due to: {err}")
    ...
    def set_status_led(self, color):     
        try:
            ...
            helper_logger.log_error(f"Failed to set status LED due to: {err}")
            return False
        return True
    ...
    def get_sfp(self, index):
        ...
        For Hawkeye the index in sfputil.py starts from 1, so override
        Args:
