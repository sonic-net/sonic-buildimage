/*
 * cpld_b .c - The CPLD driver for the Base Board of es2010
 * The driver implement sysfs to access CPLD register on the baseboard of es2010 via LPC bus.
...
/**
 * Show the front panel psu led
 * @param  dev     kernel device
 * @param  devattr kernel device attribute
 * @param  buf     buffer for get value
 * @return         psu led color (string).
 */
...
MODULE_DESCRIPTION("Celestica ES2010 LPC Baseboard CPLD Driver");
