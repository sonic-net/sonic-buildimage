...
class Psu(PddfPsu):
    ...
    def get_presence(self):
        ...
        status, result = self._api_helper.cpld_lpc_read(0x0A52)
    ...
    def get_powergood_status(self):
        idx = self.psu_index - 1        
        status, result = self._api_helper.cpld_lpc_read(0x0A51)
        mask = (1 << idx + 4) | (1 << idx)
    ...
    def get_revision(self):
        ...
        if self._api_helper.with_bmc():
            ...
            output = self._api_helper.i2c_read(99 + self.psu_index - 1, 0x50, 0x30, 3)
