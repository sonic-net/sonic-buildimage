...
try:
    ...
    from .fan_drawer_eeprom import FanDrawerEeprom
...
class Fan(PddfFan):
    ...
    def __init__(self, tray_idx, fan_idx=0, pddf_data=None, pddf_plugin_data=None, is_psu_fan=False, psu_index=0):
        ...
        self.target_speed = 0
        if not BMC_EXIST:
            self.fandrawer_eeprom = FanDrawerEeprom(pddf_data, pddf_plugin_data, tray_idx)
    ...
    def get_direction(self):
        ...
        if BMC_EXIST:
            ...
            dir = self.fandrawer_eeprom.dir_str()
    ...
    def get_status_led(self):
        ...
        if self.get_presence():
            if BMC_EXIST:
                ...
                result = self._api_helper.i2c_read(self.FAN_CPLD_BUS, self.FAN_CPLD_DEVICE, reg, 1)
                if result:
    ...
    def get_model(self):
        ...
        if self.is_psu_fan:
            ...
            if BMC_EXIST:
                ...
                return self.fandrawer_eeprom.part_number_str()
    ...
    def get_serial(self):
        ...
        if self.is_psu_fan:
            ...
            if BMC_EXIST:
                ...
                return self.fandrawer_eeprom.serial_str()
    ...
    def get_mfr_id(self):
        ...
        if self.is_psu_fan:
            ...
            if BMC_EXIST:
                ...
                return self.fandrawer_eeprom.mfr_str()
