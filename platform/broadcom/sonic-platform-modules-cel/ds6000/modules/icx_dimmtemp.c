...
static struct attribute *dimm_attrs[] = { &dev_attr_temp1_input.attr,
					  &dev_attr_temp2_input.attr, NULL };

static const struct attribute_group dimm_group = {
	.attrs = dimm_attrs,
};

static const struct attribute_group *dimm_groups[] = { &dimm_group, NULL };
...
static int __init dimm_temp_init(void)
{
	...
	dimm_dev->hwdev = hwmon_device_register_with_groups(
		NULL, MODULE_NAME, dimm_dev, dimm_groups);
