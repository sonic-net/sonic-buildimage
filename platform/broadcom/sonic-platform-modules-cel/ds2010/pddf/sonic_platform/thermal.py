...
NONPDDF_THERMAL_SENSORS = {
    ...
    "PSU 1 TEMP2":     { "label": "psu_pmbus-i2c-10-58",
                        "temp_cmd": ['i2cget', '-y', '-f', '10', '0x58', '0x8e', 'w']},
    "PSU 1 TEMP3":     { "label": "psu_pmbus-i2c-10-58",
                        "temp_cmd": ['i2cget', '-y', '-f', '10', '0x58', '0x8f', 'w']},
    "PSU 2 TEMP2":     { "label": "psu_pmbus-i2c-11-59",
                        "temp_cmd": ['i2cget', '-y', '-f', '11', '0x59', '0x8e', 'w']},
    "PSU 2 TEMP3":     { "label": "psu_pmbus-i2c-11-59",
                        "temp_cmd": ['i2cget', '-y', '-f', '11', '0x59', '0x8f', 'w']},
    }
