#!/usr/bin/python
#
# This script get the sensor data from BMC using ipmitool and display
# them in lm-sensor alike format.
#
...
def read_temperature_sensors():
    sensor_list = [\
        ('TEMP_FB_U52',      'Fanboard Center Temp'),\
        ('TEMP_FB_U17',      'Fanboard Right Temp'),\
        ...
        ('VDD_CORE_Temp',    'TPS536C7 Chip Temp'),\
        ('XP3R3V_R_Temp',    'MP2975 3.3v Chip Right Temp'),\
        ('XP3R3V_L_Temp',    'MP2975 3.3v Chip Left Temp'),\
        ('XP0R8V_Temp',      'MP2975 0.8v Chip Temp')\
    ]
