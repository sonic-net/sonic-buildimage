...
NONPDDF_THERMAL_SENSORS = {
    ...
    "XP0R8V_TEMP":    { "label": "raa228228-i2c-103-20", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon79/temp1_input"},
    "XP3R3V_E_TEMP":  { "label": "isl68225-i2c-103-60", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon80/temp1_input"},
    "XP3R3V_W_TEMP":  { "label": "isl68225-i2c-103-61", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon81/temp1_input"},
    "XP0R9V_0_TEMP":  { "label": "isl68222-i2c-103-62", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon82/temp1_input"},
    "XP1R2V_0_TEMP":  { "label": "isl68222-i2c-103-62", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon82/temp2_input"},
    "XP0R9V_1_TEMP":  { "label": "isl68222-i2c-103-63", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon83/temp1_input"},
    "XP1R2V_1_TEMP":  { "label": "isl68222-i2c-103-63", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon83/temp2_input"},
    "XP0R75V_0_TEMP": { "label": "isl68225-i2c-103-67", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon84/temp1_input"},
    "XP0R75V_1_TEMP": { "label": "isl68225-i2c-103-67", "high_threshold": 90,
                        "temp_cmd": "awk '{printf $1/1000}' /sys/class/hwmon/hwmon84/temp2_input"}}
