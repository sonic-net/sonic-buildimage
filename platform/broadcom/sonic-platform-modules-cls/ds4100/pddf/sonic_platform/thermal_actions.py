...
class StepFanController():
    ...
    F2B_STEP_TEMP = [34, 38, 42]
    B2F_STEP_TEMP = [25, 30, 37]
...
class SwitchPolicyAction(ThermalPolicyActionBase):
    ...
    def execute(self, thermal_info_dict):
        ...
        api_helper.lpc_setreg(LPC_CPLD_SETREG_PATH, 0xA140, 0x00)
        api_helper.lpc_setreg(LPC_CPLD_SETREG_PATH, 0xA120, 0xFC)
