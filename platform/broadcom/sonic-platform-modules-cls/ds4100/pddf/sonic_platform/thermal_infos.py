...
class ThermalInfo(ThermalPolicyInfoBase):
    ...
    F2B_INLET_SENSORS = ["Inlet 3 Temp", "Inlet 4 Temp"]
    B2F_INLET_SENSORS = ["Fan Center Temp", "Fan Right Temp"]
    THERMAL_INLET_SENSORS = F2B_INLET_SENSORS
    THERMAL_INLET_CRITICAL_TEMP = 48
    THERMAL_SHUTDOWN_TEMP_MAP = {"CPU Internal Temp": 108, "Switch Chip Internal Temp": 108}
