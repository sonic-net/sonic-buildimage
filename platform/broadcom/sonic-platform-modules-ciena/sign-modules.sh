...
# kernel's sign-file directly.  This path is for internal development purposes
# only; these keys do not normally exist and this path is not expected to be
...
if [ "${SECURE_UPGRADE_MODE}" = "dev" ]; then
  ...
  # Signing for development kernel module iteration.
  #
