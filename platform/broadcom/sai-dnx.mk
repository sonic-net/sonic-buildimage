...
LIBSAIBCM_DNX_VERSION = 14.1.0.1.0.0.13.1
LIBSAIBCM_DNX_BRANCH_NAME = SAI_14.1.0_GA

LIBSAIBCM_DNX_URL_PREFIX = "https://packages.trafficmanager.net/public/sai/sai-broadcom/$(LIBSAIBCM_DNX_BRANCH_NAME)/$(LIBSAIBCM_DNX_VERSION)/dnx_internal"
