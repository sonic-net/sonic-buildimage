...
LIBSAIBCM_DNX_VERSION = 14.1.0.1.0.0.24.0
LIBSAIBCM_DNX_BRANCH_NAME = dev-dnx
LIBSAIBCM_DNX_URL_PREFIX = "http://sonic-pluto.wfr.ion.nokia.net/files/sonic/build/sai/$(LIBSAIBCM_DNX_BRANCH_NAME)/1425099/dnx"
