 ...
 * -------------------------------------------------------------------------------- *
 * This sample application configures the Aperta chip in reverse gearbox mode       *
 * (1x50G_PAM4 --> 2x25G_NRZ) as follows:                                           *
 ...
 *   6. Configure PHY-0 in reverse gearbox mode                                     *
 ...
 * -------------------------------------------------------------------------------- */
#define OP_MODE_STR    "1x50G PAM4 --> 2x25G NRZ Reverse Gearbox Mode(System side alternate lane)"
...
#define SYS_LANE_RATE_PHY0      bcmpLplaneDataRate_53P125G
#define SYS_MODULATION_PHY0     bcmplpModulationPAM4
#define SYS_FEC_MODE_PHY0       bcmplpapertaRSFEC
#define SYS_IF_TYPE_PHY0        bcm_pm_InterfaceKR
#define SYS_IF_MODE_PHY0        0
#define SYS_PORT_TYPE_PHY0      bcmplpPortTypeReverseGearBox
...
#define LINE_LANE_RATE_PHY0     bcmpLplaneDataRate_25P78125G
#define LINE_MODULATION_PHY0    bcmplpModulationNRZ
#define LINE_FEC_MODE_PHY0      bcmplpapertaNoFEC
#define LINE_IF_TYPE_PHY0       bcm_pm_InterfaceKR
#define LINE_IF_MODE_PHY0       0
#define LINE_PORT_TYPE_PHY0     bcmplpPortTypeReverseGearBox
...
#define SYS_PORT_TYPE_PHY1      LINE_PORT_TYPE_PHY0
...
#define LINE_PORT_TYPE_PHY1     LINE_PORT_TYPE_PHY0
...
int main(int argc, char *argv[])
{
    ...
    bcm_plp_laneswap_map_t sys_laneswap_map[] = {
        {
          ...
          {{ 1,  0,  3,  2,  5,  4,  7,  6 }},  /* PHY-0 SYS : lane_map_rx[x]=y means that rx lane x is mapped to rx lane y */
           { 1,  0,  3,  2,  5,  4,  7,  6 }    /* PHY-0 SYS : lane_map_tx[x]=y means that tx lane x is mapped to tx lane y */
        },
        {
          CHIP_MAX_LANES,                       /* Total number of lanes */
    ...
    for (phy_index = 0; phy_index < NUM_OF_PHY; phy_index++) {
        ...
        for (lane_map_index = 0; lane_map_index < total_lane_maps; lane_map_index++) {
            ...
            sys_port_type   = (phy_index == 0) ? SYS_PORT_TYPE_PHY0  : SYS_PORT_TYPE_PHY1;
            line_port_type  = (phy_index == 0) ? LINE_PORT_TYPE_PHY0 : LINE_PORT_TYPE_PHY1;
    ...
    printf("Ports are setup now and ready to test with traffic in reverse gear box mode\n");
    printf("++++++++++++++++++++++++++++++++++++++++++++++++\n");
