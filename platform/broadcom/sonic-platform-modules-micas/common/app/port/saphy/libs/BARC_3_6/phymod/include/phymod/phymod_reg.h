...
#ifndef __plp_barchetta_PHYMOD_REG_H__
#define __plp_barchetta_PHYMOD_REG_H__
...
extern int
plp_barchetta_phymod_reg_read(plp_barchetta_phymod_access_t *pa, uint32_t addr, uint32_t *data);

extern int
plp_barchetta_phymod_reg_write(plp_barchetta_phymod_access_t *pa, uint32_t addr, uint32_t data);

#endif /* __plp_barchetta_PHYMOD_REG_H__ */
