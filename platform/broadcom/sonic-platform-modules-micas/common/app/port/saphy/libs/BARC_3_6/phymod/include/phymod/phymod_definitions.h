...
#ifndef _plp_barchetta_PHYMOD_DEFINITIONS_H_
#define _plp_barchetta_PHYMOD_DEFINITIONS_H_

#include <phymod/phymod_system.h>

#define _PHYMOD_MSG(string) string "\n"


#ifdef PHYMOD_DIAG 
typedef struct plp_barchetta_enum_mapping_s {
    char        *key;           /* String to match */
    uint32_t    enum_value;     /* Value associated with string */
} plp_barchetta_enum_mapping_t;
#endif
...
#endif /*_plp_barchetta_PHYMOD_DEFINITIONS_H_*/
