 ...
 * --------------------------------------------------------------------------------------- *
 * This sample application demonstrate the usage of Line side Force Tx Training for PAM4   *
...
#define OP_MODE_STR             "100G PAM4 (2x51.5625G) Retimer - Line Side Force Tx Training Demonstration"
