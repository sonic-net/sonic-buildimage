...
/** DSC_STATES Enum **/
enum plp_barchetta_srds_dsc_state_enum {
...
enum plp_barchetta_srds_pmd_uc_cmd_enum {
  CMD_NULL                =  0,
  CMD_UC_CTRL             =  1,
  CMD_HEYE_OFFSET         =  2,
  CMD_VEYE_OFFSET         =  3,
...
enum plp_barchetta_srds_pmd_uc_ctrl_cmd_enum {
...
enum plp_barchetta_srds_pmd_uc_diag_cmd_enum {
...
enum plp_barchetta_srds_pmd_event_rd_cmd_enum {
...
enum plp_barchetta_srds_pmd_uc_dbg_cmd_enum {
...
/** Media type Enum */
enum plp_barchetta_srds_media_type_enum {
...
enum plp_barchetta_srds_diag_ber_mode_enum {
    DIAG_BER_POS  = 0,
    DIAG_BER_NEG  = 1,
    DIAG_BER_VERT = 0,
    DIAG_BER_HORZ = 1<<1,
