...
#ifndef PEREGRINE5_PC_API_DECODE_PRINT_H
#define PEREGRINE5_PC_API_DECODE_PRINT_H
 ...
 */
extern err_code_t plp_aperta2_peregrine5_pc_decode_uc_sts_ext(srds_access_t *sa__, uint16_t bits, char *buf, size_t buf_size, const char * const prepended_text);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
extern err_code_t plp_aperta2_peregrine5_pc_decode_uc_sts(srds_access_t *sa__, uint8_t bits, char *buf, size_t buf_size, const char * const prepended_text);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
extern err_code_t plp_aperta2_peregrine5_pc_decode_core_sts(srds_access_t *sa__, uint8_t bits, char *buf, size_t buf_size, const char * const prepended_text);
