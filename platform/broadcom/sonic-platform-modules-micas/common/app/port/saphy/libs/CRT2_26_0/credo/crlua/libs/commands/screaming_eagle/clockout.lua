...
slash.register_chip_command({"clockout", "status"}, credo.FAMILY_SCREAMING_EAGLE, [[
...
slash.register_chip_command({"clockout", "enable"}, credo.FAMILY_SCREAMING_EAGLE, [[
Enable clock output
...
slash.register_chip_command({"clockout", "disable"}, credo.FAMILY_SCREAMING_EAGLE, [[
Enable clock output
