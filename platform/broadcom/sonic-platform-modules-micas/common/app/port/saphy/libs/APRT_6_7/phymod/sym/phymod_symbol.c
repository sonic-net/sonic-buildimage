...
{
    int i; 
    plp_aperta_phymod_symbol_t *sym;
    ...
    for (i = 0; (sym = (plp_aperta_phymod_symbol_t*)(ptr)) && (i < size); i++) {
...
const plp_aperta_phymod_symbol_t *
phymod_symbol_find(const char *name, const plp_aperta_phymod_symbol_t *table, int size)
{
    return (plp_aperta_phymod_symbol_t*) __phymod_symbol_find(name, table, size, sizeof(plp_aperta_phymod_symbol_t)); 
}


int 
plp_aperta_phymod_symbols_find(const char *name, const plp_aperta_phymod_symbols_t *symbols, plp_aperta_phymod_symbol_t *rsym)
{
    const plp_aperta_phymod_symbol_t *s = NULL; 
