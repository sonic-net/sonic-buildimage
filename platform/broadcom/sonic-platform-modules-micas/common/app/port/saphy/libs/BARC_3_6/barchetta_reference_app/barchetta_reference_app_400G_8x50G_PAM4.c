 ...
 * -------------------------------------------------------------------------------- *
 * This sample application configures the Barchetta chip for 400G PAM4 (8x50G)      *
 * mode as follow:                                                                  *
...
/* 400G PAM4 (8x50G) Retimer */
#define OP_MODE_STR             "400G PAM4 (8x50G) Retimer"
