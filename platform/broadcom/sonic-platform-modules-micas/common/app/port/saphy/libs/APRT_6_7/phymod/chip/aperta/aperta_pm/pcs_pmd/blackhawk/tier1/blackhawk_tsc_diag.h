...
/** Column definition header for plp_aperta_blackhawk_tsc_display_core_state() API output.
 * To be called before plp_aperta_blackhawk_tsc_display_core_state_line() API.
 ...
 * Call plp_aperta_blackhawk_tsc_display_core_state_hdr() API before and plp_aperta_blackhawk_tsc_display_core_state_legend() after
...
/** Detailed description of each column in plp_aperta_blackhawk_tsc_display_core_state_line() API output.
 * To be called after plp_aperta_blackhawk_tsc_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function only initiates the processor actions.  User must use plp_aperta_blackhawk_tsc_read_eye_scan_stripe() function
 ...
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param ber_scan_mode configures the type of test (use #plp_aperta_srds_diag_ber_mode_enum)         \n
 * \verbatim
  bit  7  - reserved
 ...
 * @param ber_scan_mode the type of test used to take the data(use #plp_aperta_srds_diag_ber_mode_enum)
 ...
 * plp_aperta_blackhawk_tsc_start_ber_scan_test(), plp_aperta_blackhawk_tsc_read_ber_scan_data(), plp_aperta_blackhawk_tsc_display_ber_scan_data().
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #plp_aperta_srds_diag_ber_mode_enum)
 ...
 * \n Note: Call functions plp_aperta_blackhawk_tsc_display_lane_state_hdr() before and plp_aperta_blackhawk_tsc_display_lane_state_legend() after
 ...
 * To be called before plp_aperta_blackhawk_tsc_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * To be called after plp_aperta_blackhawk_tsc_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 *     enum #plp_aperta_srds_diag_level_enum can be used to help set the diag_level \n
 * \verbatim
 ...
 * This function is required to be implemented by upper level software to enable blackhawk_tsc support.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param type controls the type of access requested specified through enum #plp_aperta_srds_diag_access_enum \n
 * \verbatim
