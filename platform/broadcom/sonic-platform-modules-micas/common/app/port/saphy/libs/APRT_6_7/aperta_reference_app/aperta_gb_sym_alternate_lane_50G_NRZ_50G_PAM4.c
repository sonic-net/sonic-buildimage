 ...
 *   6. Configure PHY-0 and PHY-1 in forward gearbox mode                           *
...
#define LINE_FEC_MODE           bcmplpapertaRSFEC
...
int main(int argc, char *argv[])
{
    ...
    bcm_plp_laneswap_map_t line_laneswap_map[]= {
        ...
        {
           CHIP_MAX_LANES,                       /* Total number of lanes */
           {{ 1,  0,  3,  2,  5,  4,  7,  6 }},  /* PHY-1 LINE : lane_map_rx[x]=y means that rx lane x is mapped to rx lane y */
            { 1,  0,  3,  2,  5,  4,  7,  6 }    /* PHY-1 LINE : lane_map_tx[x]=y means that tx lane x is mapped to tx lane y */
        }
    };
