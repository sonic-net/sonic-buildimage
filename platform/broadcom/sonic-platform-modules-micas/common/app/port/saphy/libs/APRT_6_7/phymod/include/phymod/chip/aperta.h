...
#ifndef _APERTA_H__H_
#define _APERTA_H__H_
...
int plp_aperta_phy_intr_enable_set(const plp_aperta_phymod_phy_access_t* phy, uint32_t enable);
...
/*Get timesync heartbeat timestamp*/
...
int plp_aperta_timesync_time_code_set(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, const plp_aperta_phymod_timesync_timespec_t* timecode);
int plp_aperta_timesync_time_code_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, plp_aperta_phymod_timesync_timespec_t* timecode);

/*Set/Get timesync link delay*/
int plp_aperta_timesync_link_delay_set(const plp_aperta_phymod_phy_access_t* phy, int txrx, uint32_t op, uint32_t msg_type, uint64_t linkdelay);
int plp_aperta_timesync_link_delay_get(const plp_aperta_phymod_phy_access_t* phy, int txrx, uint32_t* op, uint32_t* msg_type, uint64_t* linkdelay);

/*Set/Get timesync countstamp offset*/
int plp_aperta_timesync_timestamp_offset_set(const plp_aperta_phymod_phy_access_t* phy, int txrx, uint32_t op, uint32_t msg_type, uint64_t ts_offset);
int plp_aperta_timesync_timestamp_offset_get(const plp_aperta_phymod_phy_access_t* phy, int txrx, uint32_t* op, uint32_t* msg_type, uint64_t* ts_offset);

/*Set/Get timesync timer/clock/frequency value*/
int plp_aperta_timesync_timing_control_set(const plp_aperta_phymod_phy_access_t* phy, uint32_t type, uint64_t value, uint64_t value_hi, uint64_t dpll_value, uint64_t dpll_value_hi);
int plp_aperta_timesync_timing_control_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t type, uint64_t* value, uint64_t* value_hi, uint64_t* dpll_value, uint64_t* dpll_value_hi);
...
int plp_aperta_timesync_sopmem_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, int index, phymod_timesync_sopmem_t* sopentry);

/*Set/Get timesync MPLS config*/
int plp_aperta_timesync_mpls_set(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, const plp_aperta_phymod_timesync_mpls_ctrl_t* config);
int plp_aperta_timesync_mpls_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, plp_aperta_phymod_timesync_mpls_ctrl_t* config);

/*Set/Get timesync inband filter config*/
int plp_aperta_timesync_inband_filter_set(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, uint32_t index, const phymod_timesync_inband_filter_ctrl_t* config);
int plp_aperta_timesync_inband_filter_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t flags, uint32_t index, phymod_timesync_inband_filter_ctrl_t* config);
