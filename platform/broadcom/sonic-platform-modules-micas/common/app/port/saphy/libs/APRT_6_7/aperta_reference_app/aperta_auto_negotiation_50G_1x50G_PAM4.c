 ...
 *   6. Configure operating mode parameters for 50G PAM4 (1x50G) mode               *
...
/* 50G (1x50G) PAM4 Autoneg demonstration (IEEE) */
#define OP_MODE_STR    "50G (1x50G) PAM4 Autoneg demonstration (IEEE)"
...
#define CL72_EN         1
#define TECH_ABILITY    bcmplpAnCap50G_CR_KR
...
#define LINE_FEC_MODE           bcmplpapertaRS544
