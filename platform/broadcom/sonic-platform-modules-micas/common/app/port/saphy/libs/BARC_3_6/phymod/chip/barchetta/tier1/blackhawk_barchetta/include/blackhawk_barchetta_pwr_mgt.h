...
/** @file blackhawk_barchetta_pwr_mgt.h
 * Power management functions provided to IP User
 */
#ifndef BLACKHAWK_BARCHETTA_API_PWR_MGT_H
#define BLACKHAWK_BARCHETTA_API_PWR_MGT_H
 ...
 * Note: User also needs to configure all lanes through plp_barchetta_blackhawk_barchetta_lane_config_for_iddq()
 ...
 * Along with plp_barchetta_blackhawk_barchetta_core_pwrdn(), all lanes powerdowns should also be issued using
 * plp_barchetta_blackhawk_barchetta_lane_pwrdn() to complete a Core Powerdown.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param mode based on enum #plp_barchetta_srds_core_pwrdn_mode_enum select from ON, CORE, DEEP power down modes
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: User needs to configure all lanes through plp_barchetta_blackhawk_barchetta_lane_config_for_iddq() and also call plp_barchetta_blackhawk_barchetta_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param mode Enable/Disable lane powerdown based on #plp_barchetta_srds_core_pwrdn_mode_enum
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
