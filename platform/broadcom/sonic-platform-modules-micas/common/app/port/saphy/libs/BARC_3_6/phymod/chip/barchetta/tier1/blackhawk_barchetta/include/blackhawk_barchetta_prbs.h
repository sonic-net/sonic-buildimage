...
/** @file blackhawk_barchetta_prbs.h
 * PRBS test functions provided to IP User
 */

#ifndef BLACKHAWK_BARCHETTA_API_PRBS_H
#define BLACKHAWK_BARCHETTA_API_PRBS_H
 ...
 * NOTE: plp_barchetta_blackhawk_barchetta_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane. \n\n
 * 
 ...
 * Note: The patt_length input to the function should be the value sent to the plp_barchetta_blackhawk_barchetta_config_shared_tx_pattern() function
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in plp_barchetta_blackhawk_barchetta_config_shared_tx_pattern()
 ...
 * Once the PRBS generator is configured, to enable PRBS use the plp_barchetta_blackhawk_barchetta_tx_prbs_en() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Once the PRBS checker is configured, use the plp_barchetta_blackhawk_barchetta_rx_prbs_en() API to enable the checker.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
struct blackhawk_barchetta_prbs_chk_hw_timer_ctrl_st {
...
extern const char* plp_barchetta_blackhawk_barchetta_e2s_prbs_mode_enum[17];

/*---------------------------------*/
/*  PRBS Error Analyzer Functions  */
/*---------------------------------*/

#define BLACKHAWK_BARCHETTA_PRBS_FEC_FRAME_SIZE_MULTIPLIER         320
#define BLACKHAWK_BARCHETTA_PRBS_FEC_FRAME_SIZE_ROUND_UP           240  /* 3/4th of difference b/w configurable fec_size's (320) */
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_FEC_SIZE_MIN         ( 6 * BLACKHAWK_BARCHETTA_PRBS_FEC_FRAME_SIZE_MULTIPLIER)
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_FEC_SIZE_MAX         (63 * BLACKHAWK_BARCHETTA_PRBS_FEC_FRAME_SIZE_MULTIPLIER)
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_ERR_THRESH_MIN        1 
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_ERR_THRESH_MAX       15
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_HIST_ERR_THRESH_MIN   1
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_HIST_ERR_THRESH_MAX   8
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_FRAME_OVERLAP_FACTOR  8
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_LINEARITY_ADJUST      1.0
#define BLACKHAWK_BARCHETTA_PRBS_ERR_ANALYZER_NUM_COUNTERS          8
...
} blackhawk_barchetta_prbs_err_analyzer_errcnt_st;
...
typedef struct {
  ...
  uint8_t delta_n;
} blackhawk_barchetta_prbs_err_analyzer_report_st;
 ...
 * Reads out the PRBS error counters and accumulates the error count in #blackhawk_barchetta_prbs_err_analyzer_errcnt_st.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *err_analyzer PRBS Error Analyzer Error Count & Thresholds (includes total FEC Frame errors and also FEC frame errors with > x, x+1,..,x+7 errors)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
