...
slash.register_chip_command({"prbs", "monitor"}, credo.FAMILY_VICEROY, [[
...
slash.register_chip_command({"prbs", "training", "status"}, credo.FAMILY_VICEROY, [[
...
slash.register_chip_command({"prbs", "training", "relink"}, credo.FAMILY_VICEROY, [[
...
slash.register_chip_command({"prbs", "training", "tx_enable"}, credo.FAMILY_VICEROY, [[
...
slash.register_chip_command({"prbs", "training", "tx_disable"}, credo.FAMILY_VICEROY, [[
