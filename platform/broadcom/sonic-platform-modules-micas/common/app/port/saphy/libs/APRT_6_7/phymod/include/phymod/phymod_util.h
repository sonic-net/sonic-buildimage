...
#ifndef _plp_aperta_PHYMOD_UTIL_H_
#define _plp_aperta_PHYMOD_UTIL_H_
...
int plp_aperta_phymod_convert_dump_to_txt(char *file_name, char *die, char *verbosity);
#endif
#define _SHR_LANEBMP_WBIT(_lane)                  (1U << (_lane))
#define PHYMOD_LANEPBMP_MEMBER(_bmp, _lane)       (((_bmp) & (_SHR_LANEBMP_WBIT(_lane))) != 0)

#endif /*_plp_aperta_PHYMOD_UTIL_H_*/
