...
slash.register_chip_command({"serdes", "param"}, credo.FAMILY_MONARCH2P1_TEST, [[
...
slash.register_chip_command({"serdes", "control"}, credo.FAMILY_MONARCH2P1_TEST, [[
...
slash.register_chip_command({"serdes", "isi"}, credo.FAMILY_MONARCH2P1_TEST, [[
...
serdes.register_tx_taps(credo.FAMILY_MONARCH2P1_TEST, {"pre1", "main", "post1", "post2"})

slash.register_chip_command({"serdes", "tx_taps_nl"}, credo.FAMILY_MONARCH2P1_TEST, [[
...
slash.register_chip_command({"serdes", "tx_6taps"}, credo.FAMILY_MONARCH2P1_TEST, [[
Get/Set tx 6-taps
