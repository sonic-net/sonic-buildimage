...
#ifndef PEREGRINE5_PC_API_INTERNAL_ERROR_H
#define PEREGRINE5_PC_API_INTERNAL_ERROR_H
...
#define peregrine5_pc_error_report(sa__, err_code) \
        plp_aperta2_peregrine5_pc_INTERNAL_print_err_msg_and_triage_info(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
#else
#define peregrine5_pc_error_report(sa__, err_code) (err_code)
#endif
/* Prints error code, containing function, file and line number */
#ifndef SMALL_FOOTPRINT
#define peregrine5_pc_error(sa__, err_code) \
        plp_aperta2_peregrine5_pc_INTERNAL_print_err_msg(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
#else
#define peregrine5_pc_error(sa__, err_code) (err_code)
#endif
#ifndef SMALL_FOOTPRINT
 ...
 * @return Error Code.
 */
err_code_t plp_aperta2_peregrine5_pc_INTERNAL_print_err_msg(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 * @return Error Code.
 */
err_code_t plp_aperta2_peregrine5_pc_INTERNAL_print_err_msg_and_triage_info(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 */
const char* plp_aperta2_peregrine5_pc_INTERNAL_e2s_err_code(err_code_t err_code);
