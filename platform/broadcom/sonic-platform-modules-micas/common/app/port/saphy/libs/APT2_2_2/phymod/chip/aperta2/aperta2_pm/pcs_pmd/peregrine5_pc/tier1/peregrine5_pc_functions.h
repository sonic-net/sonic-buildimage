...
/*********************************************************************************
 *********************************************************************************
 *  File Name  :  peregrine5_pc_functions.h
...
#ifndef PEREGRINE5_PC_API_FUNCTIONS_H
#define PEREGRINE5_PC_API_FUNCTIONS_H
    ...
    do  { \
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return peregrine5_pc_error_report(sa__, *(__ERR)); \
        }\
        (void)srds_err_code; \
    }   while(0)
 ...
 *
 * This macro can be called in place of plp_aperta2_peregrine5_pc_INTERNAL_match_ucode_from_info()
