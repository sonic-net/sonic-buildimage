 ...
 * -------------------------------------------------------------------------------- *
 * This sample application configures the Aperta2 chip for 50G(2x25G) NRZ with      *
 ...
 *   5.  Configure operating mode parameters for 50G(2x25G) NRZ mode with system    *
 *       Octal crossing and system side failover port                               *
...
/* System side octal crossing where octal0 in system side crossed to line side octal1
 * and system side failover in octal1*/
