 ...
 *   6. Setup link training (Not mandatory)                                         *
 *   8. Close the connection to the board.                                          *
 * -------------------------------------------------------------------------------- *
 * Note 1 : This sample application is only for 81384 parts.                        *
 * -------------------------------------------------------------------------------- */

/* 100G NRZ (4x25G) MACsec static bypass mode */
#define OP_MODE_STR    "100G NRZ (4x25G) MACsec static bypass Pre-Warmboot"
