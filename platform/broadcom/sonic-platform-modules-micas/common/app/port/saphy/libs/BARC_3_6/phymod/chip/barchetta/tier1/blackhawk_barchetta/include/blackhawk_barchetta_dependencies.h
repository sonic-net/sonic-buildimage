...
/** @file blackhawk_barchetta_dependencies.h
 * Dependencies to be provided by IP User
 */

#ifndef BLACKHAWK_BARCHETTA_API_DEPENDENCIES_H
#define BLACKHAWK_BARCHETTA_API_DEPENDENCIES_H
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t plp_barchetta_blackhawk_barchetta_delay_ns(srds_access_t *sa__, uint16_t delay_ns);
#else
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t plp_barchetta_blackhawk_barchetta_delay_us(srds_access_t *sa__, uint32_t delay_us);
#else
err_code_t plp_barchetta_blackhawk_barchetta_delay_us(uint32_t delay_us);
#endif
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t plp_barchetta_blackhawk_barchetta_delay_ms(srds_access_t *sa__, uint32_t delay_ms);
#else
err_code_t plp_barchetta_blackhawk_barchetta_delay_ms(uint32_t delay_ms);
#endif
...
#define blackhawk_barchetta_get_physical_lane plp_barchetta_blackhawk_barchetta_get_lane
...
#define blackhawk_barchetta_set_physical_lane plp_barchetta_blackhawk_barchetta_set_lane
...
/** Returns address of blackhawk_barchetta info table stored in upper level software.
 * @param sa__ is an opaque state vector passed through to device access functions.
 */
srds_info_t *blackhawk_barchetta_get_info_table_address(srds_access_t *sa__);
#endif
