...
#ifndef __plp_barchetta_PHYMOD_TYPES_H__
#define __plp_barchetta_PHYMOD_TYPES_H__
...
typedef uint32_t plp_barchetta_phy_id_t;

typedef uint32_t plp_barchetta_core_id_t;


#endif /* __plp_barchetta_PHYMOD_TYPES_H__ */
