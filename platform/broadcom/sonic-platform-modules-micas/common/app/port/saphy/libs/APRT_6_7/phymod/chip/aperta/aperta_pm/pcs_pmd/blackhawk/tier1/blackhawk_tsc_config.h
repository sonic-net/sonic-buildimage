 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t plp_aperta_blackhawk_tsc_get_uc_core_config(srds_access_t *sa__, struct blackhawk_tsc_uc_core_config_st *struct_val);
 ...
 * \n Note: Micro should be loaded only after issuing a plp_aperta_blackhawk_tsc_uc_reset(1) followed by asserting and de-asserting
 * core_s_reset. Information table should be intialized with plp_aperta_blackhawk_tsc_init_blackhawk_tsc_info after microcode load.
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [plp_aperta_blackhawk_tsc_ucode_crc_verify()] and verifying the CRC value [plp_aperta_blackhawk_tsc_start_ucode_crc_calc()].
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [plp_aperta_blackhawk_tsc_ucode_crc_verify()] and verifying the CRC value [plp_aperta_blackhawk_tsc_start_ucode_crc_calc()].
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * NOTE: Information table should be intialized with plp_aperta_blackhawk_tsc_init_blackhawk_tsc_info after microcode load.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Initialize the plp_aperta_blackhawk_tsc_info for the uC.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
#define blackhawk_tsc_configure_pll_refclk_div_vco plp_aperta_blackhawk_tsc_INTERNAL_configure_pll
/** Configure PLL.
 *
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t plp_aperta_blackhawk_tsc_get_uc_lane_cfg(srds_access_t *sa__, struct blackhawk_tsc_uc_lane_config_st *struct_val);
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the plp_aperta_blackhawk_tsc_stop_rx_adaptation() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param param Enum (#plp_aperta_srds_rx_afe_settings_enum) to select the required RX AFE setting to be modified
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param param Enum (#plp_aperta_srds_rx_afe_settings_enum) to select the required RX AFE setting to be read
 * @param *val Value to be written to the selected AFE setting
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
