...
#ifndef _APERTA_DIAGNOSTICS_H__H_
#define _APERTA_DIAGNOSTICS_H__H_
...
int plp_aperta_phy_pattern_enable_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t* enable, const plp_aperta_phymod_pattern_t* pattern);
