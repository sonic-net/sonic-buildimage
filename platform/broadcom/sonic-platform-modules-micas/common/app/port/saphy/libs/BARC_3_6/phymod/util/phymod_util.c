...
#ifdef PHYMOD_APERTA_SUPPORT
int phymod_convert_dump_to_txt(char *file_name, char *die, char *in_verbosity) 
{
    ...
    phymod_dump_display_debug_regs(templatefile, dumpfile, dictfile, die_selection, verbosity, opfile);
    return 0;

}
#endif

int plp_barchetta_phymod_util_lane_config_get(const plp_barchetta_phymod_access_t *phys, int *start_lane, int *num_of_lane)
{
    int i ;
...
int plp_barchetta_phymod_swap_bit(uint16_t original_value, uint16_t *swapped_val)
{
...
int plp_barchetta_phymod_count_set_bits(int data)
{
...
int plp_barchetta_phymod_util_lane_mask_get(int start_lane, int num_of_lane, uint32_t *lane_mask)
{
    int i ;
...
int plp_barchetta_phymod_custom_diag_dump_hdr(const plp_barchetta_phymod_phy_access_t *phy)
{
...
int plp_barchetta_phymod_custom_diag_dump_display(const plp_barchetta_phymod_phy_access_t *phy, plp_barchetta_phymod_phy_diagnostics_t *phy_diag)
{
