...
enum plp_aperta_srds_prbs_polynomial_enum {
    SRDS_PRBS_7  = 0,
    SRDS_PRBS_9  = 1,
    SRDS_PRBS_11 = 2,
    SRDS_PRBS_15 = 3,
...
enum plp_aperta_srds_prbs_checker_mode_enum {
...
enum plp_aperta_srds_tx_pi_freq_jit_gen_enum {
...
enum plp_aperta_srds_rx_afe_settings_enum {
    SRDS_RX_AFE_PF,
    SRDS_RX_AFE_PF2,
    SRDS_RX_AFE_VGA,
    SRDS_RX_AFE_DFE1,
...
/** Repeater Mode Enum */
enum plp_aperta_srds_rptr_mode_enum {
    SRDS_DATA_IN_SIDE,
    SRDS_DIG_LPBK_SIDE,
    SRDS_RMT_LPBK_SIDE
};
...
enum plp_aperta_srds_core_pwrdn_mode_enum {
    SRDS_PWR_ON,
    SRDS_PWRDN,
    SRDS_PWRDN_DEEP,
    SRDS_PWRDN_TX,
...
enum plp_aperta_srds_eye_scan_dir_enum {
...
enum plp_aperta_srds_diag_level_enum {
    SRDS_DIAG_LANE = 1,
    SRDS_DIAG_CORE = 1<<1,
    SRDS_DIAG_EVENT = 1<<2,
    SRDS_DIAG_EYE = 1<<3,
...
enum plp_aperta_srds_diag_access_enum {
    SRDS_REG_READ,
    SRDS_REG_RMW,
