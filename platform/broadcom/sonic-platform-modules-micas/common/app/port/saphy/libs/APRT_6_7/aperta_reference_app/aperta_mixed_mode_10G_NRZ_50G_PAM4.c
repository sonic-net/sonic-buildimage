 ...
 * -------------------------------------------------------------------------------- *
 * This application configures Aperta chip mixed mode of 10G NRZ and 50G PAM4       *
 ...
 *   6. Configure operating mode parameters for 10G NRZ mode in even lanes          *
 *   7. Setup link training                                                         *
 *   8. Check link status                                                           *
 *   9. Configure operating mode parameters for 50G PAM4 mode in odd lanes          *
...
#define OP_MODE_STR    "10G NRZ and 50G PAM4 mixed mode demonstration"
...
#define SYS_PORT_SPEED_1X_1          10000
#define SYS_LANE_RATE_1X_1           bcmpLplaneDataRate_10P3125G
#define SYS_MODULATION_1X_1          bcmplpModulationNRZ
#define SYS_FEC_MODE_1X_1            bcmplpapertaNoFEC
#define SYS_IF_TYPE_1X_1             bcm_pm_InterfaceKR
#define SYS_IF_MODE_1X_1             0
#define SYS_PORT_TYPE_1X_1           bcmplpPortTypePassthrough

unsigned int sys_lane_map_list_1x_1[] = {
                                          0x01,
                                          0x04,
                                          0x10,
                                          0x40
...
#define LINE_PORT_SPEED_1X_1         10000
#define LINE_LANE_RATE_1X_1          bcmpLplaneDataRate_10P3125G
#define LINE_MODULATION_1X_1         bcmplpModulationNRZ
#define LINE_FEC_MODE_1X_1           bcmplpapertaNoFEC
#define LINE_IF_TYPE_1X_1            bcm_pm_InterfaceKR
#define LINE_IF_MODE_1X_1            0
#define LINE_PORT_TYPE_1X_1          bcmplpPortTypePassthrough

unsigned int line_lane_map_list_1x_1[] ={
                                          0x01,
                                          0x04,
                                          0x10,
                                          0x40
...
/*--------------------------------- Second Set -------------------------------------*/
/* System side parameters */
#define SYS_PORT_SPEED_1X_2          50000
#define SYS_LANE_RATE_1X_2           bcmpLplaneDataRate_53P125G
#define SYS_MODULATION_1X_2          bcmplpModulationPAM4
#define SYS_FEC_MODE_1X_2            bcmplpapertaRS544
#define SYS_IF_TYPE_1X_2             bcm_pm_InterfaceKR
#define SYS_IF_MODE_1X_2             0
#define SYS_PORT_TYPE_1X_2           bcmplpPortTypePassthrough

unsigned int sys_lane_map_list_1x_2[] = {
                                          0x02,
                                          0x08,
                                          0x20,
                                          0x80
...
/* Line side parameters */
#define LINE_PORT_SPEED_1X_2         50000
#define LINE_LANE_RATE_1X_2          bcmpLplaneDataRate_53P125G
#define LINE_MODULATION_1X_2         bcmplpModulationPAM4
#define LINE_FEC_MODE_1X_2           bcmplpapertaRS544
#define LINE_IF_TYPE_1X_2            bcm_pm_InterfaceKR
#define LINE_IF_MODE_1X_2            0
#define LINE_PORT_TYPE_1X_2          bcmplpPortTypePassthrough

unsigned int line_lane_map_list_1x_2[] ={
                                          0x02,
                                          0x08,
                                          0x20,
                                          0x80
...
int main(int argc, char *argv[])
{
    ...
    for(flex_cnt=0; flex_cnt<MAX_FLEXING_ITERATION; flex_cnt++) {
        if(flex_cnt%2 == 0) {
            total_lane_maps = NUM_ARR_ELEMENTS(sys_lane_map_list_1x_1);
            sys_port_speed  = SYS_PORT_SPEED_1X_1;
            line_port_speed = LINE_PORT_SPEED_1X_1;
            sys_lane_rate   = SYS_LANE_RATE_1X_1;
            line_lane_rate  = LINE_LANE_RATE_1X_1;
            sys_modulation  = SYS_MODULATION_1X_1;
            line_modulation = LINE_MODULATION_1X_1;
            sys_fec_mode    = SYS_FEC_MODE_1X_1;
            line_fec_mode   = LINE_FEC_MODE_1X_1;
            sys_if_type     = SYS_IF_TYPE_1X_1;
            line_if_type    = LINE_IF_TYPE_1X_1;
            sys_if_mode     = SYS_IF_MODE_1X_1;
            line_if_mode    = LINE_IF_MODE_1X_1;
            sys_port_type   = SYS_PORT_TYPE_1X_1;
            line_port_type  = LINE_PORT_TYPE_1X_1;
            sys_lane_map_list  = sys_lane_map_list_1x_1;
            line_lane_map_list = line_lane_map_list_1x_1;
        } else {
            total_lane_maps = NUM_ARR_ELEMENTS(sys_lane_map_list_1x_2);
            sys_port_speed  = SYS_PORT_SPEED_1X_2;
            line_port_speed = LINE_PORT_SPEED_1X_2;
            sys_lane_rate   = SYS_LANE_RATE_1X_2;
            line_lane_rate  = LINE_LANE_RATE_1X_2;
            sys_modulation  = SYS_MODULATION_1X_2;
            line_modulation = LINE_MODULATION_1X_2;
            sys_fec_mode    = SYS_FEC_MODE_1X_2;
            line_fec_mode   = LINE_FEC_MODE_1X_2;
            sys_if_type     = SYS_IF_TYPE_1X_2;
            line_if_type    = LINE_IF_TYPE_1X_2;
            sys_if_mode     = SYS_IF_MODE_1X_2;
            line_if_mode    = LINE_IF_MODE_1X_2;
            sys_port_type   = SYS_PORT_TYPE_1X_2;
            line_port_type  = LINE_PORT_TYPE_1X_2;
            sys_lane_map_list  = sys_lane_map_list_1x_2;
            line_lane_map_list = line_lane_map_list_1x_2;
        }
