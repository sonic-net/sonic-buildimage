...
slash.register_chip_command({"bitmux", "config"}, credo.FAMILY_HERON, [[
...
Examples:
    ...
    local msblsb_swap = choose(argt.msblsb_swap0, 1, 0) + choose(argt.msblsb_swap0, 2, 0)
    credo.port_set_option(slice, port_id, "bitmux_msblsb_swap", msblsb_swap)
