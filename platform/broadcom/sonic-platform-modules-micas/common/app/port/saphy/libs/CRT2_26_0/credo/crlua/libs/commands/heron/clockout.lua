...
slash.register_chip_command({"clockout", "status"}, credo.FAMILY_HERON, [[
...
slash.register_chip_command({"clockout", "enable"}, credo.FAMILY_HERON, [[
Enable clock output
...
slash.register_chip_command({"clockout", "disable"}, credo.FAMILY_HERON, [[
Enable clock output
