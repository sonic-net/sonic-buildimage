...
int plp_aperta_blackhawk_phy_firmware_core_config_set(const plp_aperta_phymod_phy_access_t* phy, plp_aperta_phymod_firmware_core_config_t fw_core_config);
int plp_aperta_blackhawk_phy_firmware_core_config_get(const plp_aperta_phymod_phy_access_t* phy, plp_aperta_phymod_firmware_core_config_t* fw_core_config);

/*Set\get firmware operation mode*/
int plp_aperta_blackhawk_phy_firmware_lane_config_set(const plp_aperta_phymod_phy_access_t* phy, phymod_firmware_lane_config_t fw_lane_config);
int plp_aperta_blackhawk_phy_firmware_lane_config_get(const plp_aperta_phymod_phy_access_t* phy, phymod_firmware_lane_config_t* fw_lane_config);
...
int plp_aperta_blackhawk_phy_rx_pmd_locked_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t* rx_pmd_locked);

/*Get rx pmd locked indication*/
int plp_aperta_blackhawk_phy_rx_signal_detect_get(const plp_aperta_phymod_phy_access_t* phy, uint32_t* rx_signal_detect);
...
int plp_aperta_blackhawk_phy_speed_config_set(const plp_aperta_phymod_phy_access_t* phy, const phymod_phy_speed_config_t* speed_config, const phymod_phy_pll_state_t* old_pll_state, phymod_phy_pll_state_t* new_pll_state);
