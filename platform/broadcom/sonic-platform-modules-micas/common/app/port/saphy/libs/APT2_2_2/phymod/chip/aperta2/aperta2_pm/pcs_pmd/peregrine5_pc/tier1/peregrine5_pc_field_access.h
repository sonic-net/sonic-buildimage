...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  peregrine5_pc_field_access.h                                        *
...
#ifndef PEREGRINE5_PC_API_FIELD_ACCESS_H
#define PEREGRINE5_PC_API_FIELD_ACCESS_H
...
/*---------------------------------------------------------------------------------------------------*/
/* "Serdes ACCess" (_acc_) API dependency "wrapper" functions for peregrine5_pc_dependencies.c          */
 ...
 * NOTE: This should be used instead of the API Dedendency function plp_aperta2_peregrine5_pc_pmd_rdt_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function plp_aperta2_peregrine5_pc_pmd_wr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function plp_aperta2_peregrine5_pc_pmd_mwr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t plp_aperta2_peregrine5_pc_acc_wr_pram(srds_access_t *sa__, uint8_t val);
...
#define peregrine5_pc_acc_get_physical_lane plp_aperta2_peregrine5_pc_acc_get_lane
...
#define peregrine5_pc_acc_set_physical_lane plp_aperta2_peregrine5_pc_acc_set_lane
...
/** Returns address of peregrine5_pc info table stored in upper level software.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Returns a pointer to the peregrine5_pc info table.
 */
