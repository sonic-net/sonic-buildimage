...
/***********************************************************************************
 ***********************************************************************************
 *  File Name  :  blackhawk_barchetta_functions.h                                           *
...
#ifndef BLACKHAWK_BARCHETTA_API_FUNCTIONS_H
#define BLACKHAWK_BARCHETTA_API_FUNCTIONS_H
    ...
    do  { \
        ...
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return blackhawk_barchetta_error_report(sa__, *(__ERR)); \
        }\
        (void)__err; \
    }   while(0)
/**
 ...
 *  Only used in plp_barchetta_blackhawk_barchetta_INTERNAL_print_triage_info() and requires __err to be declared.
 */
