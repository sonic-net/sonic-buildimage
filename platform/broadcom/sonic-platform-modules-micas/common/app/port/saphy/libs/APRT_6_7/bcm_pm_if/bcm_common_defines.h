 ...
 * @brief Aux PHY Controls from setting BASE-T features thru bcm_plp_aperta_mode_config_set()/_get()
 */
...
typedef enum bcm_plp_failover_switch_mode_e {
    bcmplpFailoverSwitchModeGlobal = 0, /**< active contexts are switched and the scope is global use bcm_plp_aperta_failover_mode_set to switch context */
    bcmplpFailoverSwitchModePerPort,    /**< active contexts are switched and the scope is per port determined by API bcm_plp_aperta_failover_mode_set */
    bcmplpFailoverSwitchModePinBased    /**< active contexts are switched and the scope is HMUX_GLOBAL by pin call to API bcm_plp_aperta_failover_mode_set returns error */
