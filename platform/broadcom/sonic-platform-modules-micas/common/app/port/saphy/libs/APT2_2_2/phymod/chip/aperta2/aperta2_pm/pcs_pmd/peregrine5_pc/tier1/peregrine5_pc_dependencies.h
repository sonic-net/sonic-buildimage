...
#ifndef PEREGRINE5_PC_API_DEPENDENCIES_H
#define PEREGRINE5_PC_API_DEPENDENCIES_H
 ...
 */
err_code_t plp_aperta2_peregrine5_pc_pmd_rdt_reg(srds_access_t *sa__, uint16_t address, uint16_t *val);
 ...
 * If using Serdes MDIO controller to access the registers, implement this function using peregrine5_pc_pmd_mdio_mwr_reg(..).
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function.
 *
 *    plp_aperta2_peregrine5_pc_pmd_wr_reg(addr, ((peregrine5_pc_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 */
srds_core_t plp_aperta2_peregrine5_pc_get_core(srds_access_t *sa__);
...
#define peregrine5_pc_get_physical_lane plp_aperta2_peregrine5_pc_get_lane
...
#define peregrine5_pc_set_physical_lane plp_aperta2_peregrine5_pc_set_lane
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Pointer to the peregrine5_pc info table.
 */
