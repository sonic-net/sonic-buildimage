...
typedef struct firmware_gpio_jtag_en_s {
    ...
    struct gpio_desc *en_desc;                                      /* GPIO descriptor */
...
typedef struct firmware_cpld_s {
    ...
    struct gpio_desc *tdi_desc;                                 /* TDI GPIO descriptor */
    struct gpio_desc *tck_desc;                                 /* TCK GPIO descriptor */
    struct gpio_desc *tms_desc;                                 /* TMS GPIO descriptor */
    struct gpio_desc *tdo_desc;                                 /* TDO GPIO descriptor */
} firmware_cpld_t;
