...
MANUINFO_CONF = {
    ...
    "5387_hw_version": {
        ...
        "func": {
            ...
            "params": {
                "before": [
                    {"dealtype": "io_wr", "io_addr": 0x94d, "value": 0xfe, "gettype": "io"},  # enable 5387
                    {"dealtype": "shell", "cmd": "modprobe wb_spi_gpio", "gettype": "cmd"},
                    {"dealtype": "shell", "cmd": "modprobe wb_spi_gpio_device sck=67 miso=32 mosi=65 bus=0", "gettype": "cmd"},
                    {"dealtype": "shell", "cmd": "modprobe wb_spi_93xx46 spi_bus_num=0 spi_cs_gpio=6", "gettype": "cmd"},
                    {"dealtype": "shell", "cmd": "modprobe wb_eeprom_93xx46", "gettype": "cmd"},
                ],
                "get_version": "md5sum /sys/bus/spi/devices/spi0.0/eeprom | awk '{print $1}'",
                "after": [],
                "finally": [
                    {"dealtype": "shell", "cmd": "rmmod wb_eeprom_93xx46", "gettype": "cmd"},
                    {"dealtype": "shell", "cmd": "rmmod wb_spi_93xx46", "gettype": "cmd"},
                    {"dealtype": "shell", "cmd": "rmmod wb_spi_gpio_device", "gettype": "cmd"},
                    {"dealtype": "shell", "cmd": "rmmod wb_spi_gpio", "gettype": "cmd"},
                    {"dealtype": "io_wr", "io_addr": 0x94d, "value": 0xff, "gettype": "io"},  # disable 5387
                ],
            },
        },
        "arrt_index": 3,
