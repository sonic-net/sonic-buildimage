...
#define GPIO_C3000_OFFSET   (512)    /* Formula of gpio base number in Kernel */

static int g_wb_firmware_upgrade_debug = 0;
static int g_wb_firmware_upgrade_error = 0;

module_param(g_wb_firmware_upgrade_debug, int, 0644);
module_param(g_wb_firmware_upgrade_error, int, 0644);
...
static firmware_upgrade_device_t firmware_upgrade_device_data0 = {
    .type               = "JTAG",
    .upg_type.jtag = {
        .tdi             = 89 + GPIO_C3000_OFFSET,
        .tck             = 139 + GPIO_C3000_OFFSET,
        .tms             = 87 + GPIO_C3000_OFFSET,
        .tdo             = 88 + GPIO_C3000_OFFSET,
    },

    .en_gpio[0]     = 99 + GPIO_C3000_OFFSET,
    .en_level[0]    = 1,
    .chain          = 1,
    .chip_index     = 1,
