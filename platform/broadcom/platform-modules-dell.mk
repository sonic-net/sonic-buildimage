# Dell S6000, Z9100, S6100, Z9264F, S5232F, Z9332F, Z9664F, S3248T Platform modules
...
DELL_Z9664F_PLATFORM_MODULE_VERSION= 1.1
DELL_S3248T_PLATFORM_MODULE_VERSION= 1.1
...
export DELL_Z9664F_PLATFORM_MODULE_VERSION
...
DELL_Z9664F_PLATFORM_MODULE = platform-modules-z9664f_$(DELL_Z9664F_PLATFORM_MODULE_VERSION)_amd64.deb
$(DELL_Z9664F_PLATFORM_MODULE)_PLATFORM = x86_64-dell_z9664f-r0
$(eval $(call add_extra_package,$(DELL_Z9100_PLATFORM_MODULE),$(DELL_Z9664F_PLATFORM_MODULE)))

DELL_S3248T_PLATFORM_MODULE = platform-modules-s3248t_$(DELL_S3248T_PLATFORM_MODULE_VERSION)_amd64.deb
$(DELL_S3248T_PLATFORM_MODULE)_PLATFORM = x86_64-dell_s3248t-r0
$(eval $(call add_extra_package,$(DELL_Z9100_PLATFORM_MODULE),$(DELL_S3248T_PLATFORM_MODULE)))
