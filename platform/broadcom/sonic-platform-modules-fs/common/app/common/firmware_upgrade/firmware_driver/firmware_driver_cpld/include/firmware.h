...
extern int g_firmware_cpld_driver_debug;

/* Get device information based on minor */
extern firmware_device_t *firmware_cpld_get_device_by_minor(int minor);
/* Registere device */
extern int firmware_cpld_device_register(firmware_device_t *fw_dev);
/* Unregister device */
extern void firmware_cpld_device_unregister(firmware_device_t *fw_dev);
/* Registere driver */
extern int firmware_cpld_driver_register(firmware_driver_t *fw_drv);
/* Unregister driver */
extern void firmware_cpld_driver_unregister(firmware_driver_t *fw_drv);
