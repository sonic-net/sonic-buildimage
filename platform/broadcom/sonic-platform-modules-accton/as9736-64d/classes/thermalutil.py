...
class ThermalUtil(object):
    ...
    THERMAL_NUM_10_IDX: ["/sys/bus/i2c/devices/66-004d/hwmon/hwmon*/temp2_input", "LDB TMP422(0x4d)"], #Use Remote_#2
    THERMAL_NUM_11_IDX: ["/sys/bus/i2c/devices/14-004c/hwmon/hwmon*/temp2_input", "SMB TMP422(0x4c)"], #SMB (TH4)TMP422 (0x4C), use for check MAC temperature via Remote_#2
