...
static ssize_t fpga_read_port_status_value(struct bin_attribute *eeprom)
{
    ...
    fpga_ctl->udb_cpld1_version = ioread32(fpga_ctl->pci_fpga_dev[PCI_SUBSYSTEM_ID_UDB].data_base_addr +
                                   ASLPC_DEV_UDB_CPLD1_PCIE_START_OFFST);
    fpga_ctl->udb_cpld2_version = ioread32(fpga_ctl->pci_fpga_dev[PCI_SUBSYSTEM_ID_UDB].data_base_addr +
                                   ASLPC_DEV_UDB_CPLD2_PCIE_START_OFFST);
    fpga_ctl->ldb_cpld1_version = ioread32(fpga_ctl->pci_fpga_dev[PCI_SUBSYSTEM_ID_LDB].data_base_addr +
                                   ASLPC_DEV_LDB_CPLD1_PCIE_START_OFFST);
    fpga_ctl->ldb_cpld2_version = ioread32(fpga_ctl->pci_fpga_dev[PCI_SUBSYSTEM_ID_LDB].data_base_addr +
                                   ASLPC_DEV_LDB_CPLD2_PCIE_START_OFFST);
