#!/usr/bin/python3
"""
# Module on Z9664F, the BaseBoard Management Controller is an
...
def _print_temperature_sensors():
    ...
    print('  PT Left Temp T:                 ',\
        (_get_bmc_register('PT_Left_temp_T')))
    print('  PT Left Temp B:                 ',\
        (_get_bmc_register('PT_Left_temp_B')))
    print('  PT Front Temp T:                ',\
        (_get_bmc_register('PT_Front_temp')))
    print('  PT Right Temp T:                ',\
        (_get_bmc_register('PT_Right_temp_T')))
    print('  PT Right Temp B:                ',\
        (_get_bmc_register('PT_Right_temp_B')))
    print('  NPU Front Temp:                 ',\
        (_get_bmc_register('NPU_Front_temp')))
    print('  FAN Left Temp:                  ',\
        (_get_bmc_register('FAN_Left_temp')))
    ...
    print('  CPUCD Right Temp:               ',\
        (_get_bmc_register('CPUCD_Right_temp')))
    print('  PSU1 AF Temp:                   ',\
        (_get_bmc_register('PSU1_AF_temp')))
    print('  PSU1 Front Temp:                ',\
        (_get_bmc_register('PSU1_Front_temp')))
    print('  PSU1 Rear Temp:                 ',\
        (_get_bmc_register('PSU1_Rear_temp')))
    print('  PSU2 AF Temp:                   ',\
        (_get_bmc_register('PSU2_AF_temp')))
    print('  PSU2 Front Temp:                ',\
        (_get_bmc_register('PSU2_Front_temp')))
    print('  PSU2 Rear Temp:                 ',\
        (_get_bmc_register('PSU2_Rear_temp')))
    print('  TC Rear Temp:                   ',\
        (_get_bmc_register('TC_Rear_temp')))
...
for tray in range(1, Z9664F_MAX_FAN_TRAYS + 1):
...
print('\nPSUs:')
for psu in range(1, Z9664F_MAX_PSUS + 1):
