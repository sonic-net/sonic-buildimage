...
def chassis(mock_pddf_data):
    ...
    # Mock DpmInfo import so Adm1266 uses our mock
    dpm_info_module_mock = Mock()
    dpm_info_module_mock.DpmInfo = DpmInfoMock
    sys.modules["sonic_platform.dpm_info"] = dpm_info_module_mock
