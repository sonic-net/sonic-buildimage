...
"""
Unit tests for the transceiver_pddf_parser module.
"""
...
def find_pddf_device_json(platform_variant):
    ...
    platform_pddf_path = os.path.join(CWD, BASE_PLATFORM_PDDF_PATH.format(platform_variant))
...
class TestExtractXcvrList:
    ...
    def test_extract_xcvr_list_none_config(self):
        """Test extract_xcvr_list with None configuration."""
        # When
        xcvr_list = extract_xcvr_list(None)
