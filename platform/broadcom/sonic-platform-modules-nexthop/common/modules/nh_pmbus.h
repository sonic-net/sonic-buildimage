 ...
 * Original file: drivers/hwmon/pmbus/pmbus.h
 *
...
int nh_pmbus_write_byte_data(struct i2c_client *client, int page, u8 reg,
			  u8 value);
...
int nh_pmbus_do_probe(struct i2c_client *client,
		struct pmbus_driver_info *info);
const struct pmbus_driver_info *nh_pmbus_get_driver_info(struct i2c_client
						      *client);
