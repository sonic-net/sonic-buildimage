...
$(DOCKER_SYNCD_DNX_BASE)_RUN_OPT += --cap-add=SYS_RAWIO --cap-add=SYS_ADMIN --cap-add=NET_ADMIN --cap-add=SYS_NICE -t --security-opt apparmor=unconfined --security-opt="systempaths=unconfined"
