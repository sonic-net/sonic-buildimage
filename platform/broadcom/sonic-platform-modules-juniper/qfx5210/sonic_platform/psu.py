...
class Psu(PsuBase):
    ...
    def __init__(self, psu_index=0):
        ...
        cpld_i2c_num = PSU_CPLD_I2C_MAPPING[self.index]["num"]
        cpld_i2c_addr = PSU_CPLD_I2C_MAPPING[self.index]["addr"]
        self.cpld_path = I2C_PATH.format(cpld_i2c_num, cpld_i2c_addr)
