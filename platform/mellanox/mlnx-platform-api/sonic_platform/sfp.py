    ...
    def get_temperature_info(self):
        ...
        try:
            ...
            if not sw_control:
                ...
                warning_file = f'/sys/module/sx_core/asic0/module{self.sdk_index}/temperature/warning'
                critical_file = f'/sys/module/sx_core/asic0/module{self.sdk_index}/temperature/critical'
