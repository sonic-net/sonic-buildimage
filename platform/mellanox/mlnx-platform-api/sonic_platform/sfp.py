...
class NvidiaSFPCommon(SfpOptoeBase):
    ...
    SFP_MLNX_ERROR_DESCRIPTION_BOOT_ERROR = 'Boot error'
    SFP_MLNX_ERROR_DESCRIPTION_RECOVERY_ERROR = 'Recovery error'
    SFP_MLNX_ERROR_DESCRIPTION_SUBMODULE_FAILURE = 'Submodule failure'
    SFP_MLNX_ERROR_DESCRIPTION_ELS_CRITICAL_INDICATION = 'ELS critical indication'
