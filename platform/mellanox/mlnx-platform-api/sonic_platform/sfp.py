    ...
    def get_temperature_info(self):
        ...
        try:
            ...
            if not sw_control:
                ...
                # Use threshold_hi as warning threshold and threshold_lo as critical threshold
                ...
                critical_threshold = utils.read_int_from_file(threshold_lo_file, log_func=None)
