...
class TestSfp:
    ...
    def test_get_data_from_db(self):
        ...
        assert sfp._get_data_from_db(None, None, None) == (False, None)
        
        sfp.get_logical_port.return_value = 'Ethernet0'
        mock_table = mock.MagicMock()
        def mock_get_table(namespace):
            return mock_table
        mock_table.hget = mock.MagicMock(return_value=(True, '25.5'))
        assert sfp._get_data_from_db(None, mock_get_table, 'temperature') == (True, '25.5')
    ...
    @mock.patch('sonic_platform.sfp.db_table_helper')
    def test_get_port_config_done(self, mock_db_table_helper):
        ...
        mock_db_table_helper.get_appl_db = mock.MagicMock(return_value=app_db)
