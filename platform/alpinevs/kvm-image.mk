...
SONIC_KVM_IMAGE = sonic-alpinevs.img.gz
$(SONIC_KVM_IMAGE)_INSTALLS += $(SYSTEMD_SONIC_GENERATOR)
$(SONIC_KVM_IMAGE)_INSTALLS += $(GENL_PACKET_MODULE)
$(SONIC_KVM_IMAGE)_INSTALLS += $(PKT_HANDLER)
$(SONIC_KVM_IMAGE)_MACHINE = alpinevs
