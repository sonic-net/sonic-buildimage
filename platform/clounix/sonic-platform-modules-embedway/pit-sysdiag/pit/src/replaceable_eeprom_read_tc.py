...
psu_key_list = ['productManufacturer', 'productName', 'productPartModelName', 'productSerialNumber']
fan_key_list = ['boardManufacturer', 'boardProductName', 'boardPartNumber', 'boardSerialNumber']
...
class REPLACEABLE_EEPROM_READ_TC(TestCaseCommon):
    ...
    def check_eeprom_info(self, replaceable_part, console_print=False):
        ...
        if "psu" in replaceable_part:
            key_list = psu_key_list
        else:
            key_list = fan_key_list
