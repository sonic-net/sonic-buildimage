...
#define CTL_CHAIN_INTR_MSK             0x051C00BC
#define CFG_PDMA_CH_ENABLE             0X051C1404
#define CFG_PDMA_DESC_LOCATION         0x051C1408
#define CFG_PDMA_DESC_ENDIAN           0x051C140C
#define CFG_PDMA_CRC_EN                0x051C1434
#define CFG_PDMA_DATA_ENDIAN_SWAP      0x051C1410
#define CFG_AXI_PROTO_INFO             0x051C1414
#define CFG_AXI_FIFO_ALM_FULL          0x051C1418
#define CFG_AXI_TIMEOUT_THR            0x051C141C
#define CFG_AXI0_OUTSTD_SIZE           0x051C1428
#define CFG_AXI1_OUTSTD_SIZE           0x051C142C
#define CFG_FIFIO_PATH_SEL             0x051C1430
#define CFG_CRC_EN                     0x051C1434
#define CFG_P2H_RX_FIFO_ALM_FULL       0x051C1438
#define CFG_P2H_TX_FIFO_ALM_FULL       0x051C143c
#define CFG_P2E_RX_FIFO_ALM_FULL       0x051C1440
#define CFG_P2E_TX_FIFO_ALM_FULL       0x051C1444
#define CFG_TX_FIFO_TIMEOUT_THR        0x051C1448
#define CFG_SLV_TIMEOUT_THR            0x051C144C
#define CFG_PDMA2PCIE_INTR_MASK        0X051C14A4
#define CFW_PDMA2PCIE_INTR_CLR         0X051C14A8
#define CFW_PDMA2PCIE_INTR_TEST        0X051C14AC
#define STA_PDMA_NORMAL_INTR           0X051C14B4
#define CFG_PDMA_CH0_RING_BASE         0X051C14B8
#define CFG_PDMA_CH0_RING_SIZE         0X051C1558
#define CFG_PDMA_CH0_DESC_WORK_IDX     0X051C15A8
#define STA_PDMA_CH0_DESC_POP_IDX      0X051C15F8
#define CFG_PDMA_CH0_MODE              0x051C1648
#define CFW_PDMA_CH_RESET              0X051C174C
#define CFW_PDMA_CH_RESTART            0X051C1750
#define CFG_PDMA2PCIE_INTR_MASK_ALL    0X051C2120
#define CFG_PDMA2PCIE_INTR_CH0_MASK    0X051C2124
#define IRQ_PDMA_ABNORMAL_CH0_INTR     0X051C216C
#define IRQ_PDMA_ABNORMAL_CH0_INTR_MSK 0X051C2170

#define L2_FIFO_CHANNEL   18
#define IOAM_FIFO_CHANNEL 19
#define NUM_MSI_IRQ       21

#define CFG_PDMA_CHx_RING_BASE(__channel__)     (CFG_PDMA_CH0_RING_BASE + 0x8 * (__channel__))
#define CFG_PDMA_CHx_RING_SIZE(__channel__)     (CFG_PDMA_CH0_RING_SIZE + 0x4 * (__channel__))
#define CFG_PDMA_CHx_DESC_WORK_IDX(__channel__) (CFG_PDMA_CH0_DESC_WORK_IDX + 0x4 * (__channel__))
#define STA_PDMA_CHx_DESC_POP_IDX(__channel__)  (STA_PDMA_CH0_DESC_POP_IDX + 0x4 * (__channel__))
#define CFG_PDMA_CHx_MODE(__channel__)          (CFG_PDMA_CH0_MODE + 0x4 * (__channel__))

#define CFG_PDMA2PCIE_INTR_CHx_MASK(__channel__)                               \
    (CFG_PDMA2PCIE_INTR_CH0_MASK +                                             \
     ((__channel__) == L2_FIFO_CHANNEL || (__channel__) == IOAM_FIFO_CHANNEL ? \
          ((__channel__ - 2) * 4) :                                            \
          ((__channel__) * 4)))

#define IRQ_PDMA_ABNORMAL_CHx_INTR(__channel__)                                \
    (IRQ_PDMA_ABNORMAL_CH0_INTR +                                              \
     ((__channel__) == L2_FIFO_CHANNEL || (__channel__) == IOAM_FIFO_CHANNEL ? \
          ((__channel__ - 2) * 0xC) :                                          \
          ((__channel__) * 0xC)))

#define IRQ_PDMA_ABNORMAL_CHx_INTR_MSK(__channel__)                            \
    (IRQ_PDMA_ABNORMAL_CH0_INTR_MSK +                                          \
     ((__channel__) == L2_FIFO_CHANNEL || (__channel__) == IOAM_FIFO_CHANNEL ? \
          ((__channel__ - 2) * 0xC) :                                          \
          ((__channel__) * 0xC)))
...
#define NB_PKT_TX_MAX_LEN            (10200)
#define NB_PKT_RX_MAX_LEN            (10200 + NB_PKT_PDMA_HDR_SZ) /* EPP tunnel header */
