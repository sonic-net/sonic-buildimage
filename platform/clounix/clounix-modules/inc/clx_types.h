...
typedef enum { CLX_LOCK_NORMAL = 0, CLX_LOCK_RECURSIVE, CLX_LOCK_LAST } CLX_LOCK_T;

typedef enum { CLX_DIR_INGRESS = 0, CLX_DIR_EGRESS, CLX_DIR_BOTH, CLX_DIR_LAST } CLX_DIR_T;
