...
extern int sonic_i2c_get_mod_power_en(struct i2c_client *client, XCVR_ATTR *info, struct xcvr_data *data);
extern int sonic_i2c_get_mod_power_fault(struct i2c_client *client, XCVR_ATTR *info, struct xcvr_data *data);
...
extern int sonic_i2c_get_mod_overwrite_en(struct i2c_client *client, XCVR_ATTR *info, struct xcvr_data *data);
extern int sonic_i2c_set_mod_lpmode(struct i2c_client *client, XCVR_ATTR *info, struct xcvr_data *data);
extern int sonic_i2c_set_mod_power_en(struct i2c_client *client, XCVR_ATTR *info, struct xcvr_data *data);
...
extern int sonic_i2c_set_mod_overwrite_en(struct i2c_client *client, XCVR_ATTR *info, struct xcvr_data *data);
...
extern ssize_t get_module_power_en(struct device *dev, struct device_attribute *da, char *buf);
extern ssize_t set_module_power_en(struct device *dev, struct device_attribute *da, const char *buf, size_t count);
extern ssize_t get_module_power_fault(struct device *dev, struct device_attribute *da, char *buf);
...
extern ssize_t get_module_overwrite_en(struct device *dev, struct device_attribute *da, char *buf);
extern ssize_t set_module_overwrite_en(struct device *dev, struct device_attribute *da, const char *buf, size_t count);
