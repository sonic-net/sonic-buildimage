...
DISABLED_PACKAGES_LOCAL = $(DOCKER_DHCP_RELAY) $(DOCKER_SFLOW) $(DOCKER_MGMT_FRAMEWORK) \
                          ...
                          $(DOCKER_RESTAPI) $(DOCKER_TELEMETRY) $(DOCKER_FPM)
...
$(SONIC_ONE_IMAGE)_DOCKERS = $(DOCKER_DATABASE) $(DOCKER_GNMI) $(DOCKER_PLATFORM_MONITOR) $(DOCKER_LLDP) $(DOCKER_SYSMGR) $(DOCKER_SONIC_REDFISH)
