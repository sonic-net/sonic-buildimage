...
CONFIG_FILE_PATH_LIST = [
    "/usr/share/sonic/platform/hal-config/",
    CONFIG_FILE_PATH,
    "/usr/lib/python3/dist-packages/",
    "/usr/local/lib/*/dist-packages/hal-config/",
    "/usr/lib/python3/site-packages/",
    "/usr/local/lib/python3.9/site-packages/hal-config/"
]
...
DEVICE_CONFIG_FILE_LIST = [
    ...
    platform + "_device.py",
    boardid + "_" + sub_ver + "_" + boardairflow + "_device.py",
    boardid + "_" + sub_ver + "_device.py",
    boardid + "_" + boardairflow + "_device.py",
    boardid + "_device.py",
]
...
MONITOR_CONFIG_FILE_LIST = [
    ...
    boardid + "_" + sub_ver + "_" + boardairflow + "_monitor.py",
    boardid + "_" + sub_ver + "_monitor.py",
    boardid + "_" + boardairflow + "_monitor.py",
    boardid + "_monitor.py",
]
