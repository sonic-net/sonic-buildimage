...
typedef struct firmware_spi_logic_upg_s {
    ...
    firmware_spi_logic_info_t logic_info;
...
extern int firmware_fpga_read_word(char *dev_name, uint32_t addr, uint32_t *val);
extern int firmware_fpga_write_word(char *dev_name, uint32_t addr, uint32_t val);
extern int firmware_fpga_read_buf(char *dev_name, uint32_t addr, uint8_t *buf, uint32_t rd_len);
extern int firmware_fpga_write_buf(char *dev_name, uint32_t addr, uint8_t *buf, uint32_t wr_len);
