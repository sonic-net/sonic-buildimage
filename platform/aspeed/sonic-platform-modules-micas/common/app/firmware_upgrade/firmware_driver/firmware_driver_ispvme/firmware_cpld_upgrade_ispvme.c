...
static int init_cpld(void)
{
    ...
    gpio_direction_output(current_fmw_cpld->tck, 0);
...
static int finish_cpld(void)
{
    ...
    gpio_direction_input(current_fmw_cpld->tdi);
    gpio_direction_input(current_fmw_cpld->tck);
    gpio_direction_input(current_fmw_cpld->tms);
    gpio_direction_input(current_fmw_cpld->tdo);
