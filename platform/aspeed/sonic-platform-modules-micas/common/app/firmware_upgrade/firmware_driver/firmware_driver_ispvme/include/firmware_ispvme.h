...
extern int g_firmware_ispvme_driver_debug;

/* Get device information based on minor */
extern firmware_device_t *firmware_ispvme_get_device_by_minor(int minor);
/* Registere device */
extern int firmware_ispvme_device_register(firmware_device_t *fw_dev);
/* Unregister device */
extern void firmware_ispvme_device_unregister(firmware_device_t *fw_dev);
/* Registere driver */
extern int firmware_ispvme_driver_register(firmware_driver_t *fw_drv);
/* Unregister driver */
extern void firmware_ispvme_driver_unregister(firmware_driver_t *fw_drv);
/* CPLD upgrade initialized */
extern int firmware_ispvme_init(void);
/* CPLD unload function */
extern void firmware_ispvme_exit(void);
