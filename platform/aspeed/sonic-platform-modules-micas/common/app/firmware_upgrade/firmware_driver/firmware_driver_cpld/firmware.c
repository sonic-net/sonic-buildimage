...
int g_firmware_cpld_driver_debug = 0;
module_param(g_firmware_cpld_driver_debug, int, S_IRUGO | S_IWUSR);

static LIST_HEAD(drv_list);
static LIST_HEAD(dev_list);

/**
 * firmware_cpld_driver_register
 ...
 */
int firmware_cpld_driver_register(firmware_driver_t *fw_drv)
{
    int ret;
...
/**
 * firmware_cpld_driver_unregister
 * function:unregister Device Driver
 * @fw_drv:param[in] Driver information
 */
void firmware_cpld_driver_unregister(firmware_driver_t *fw_drv)
{
...
/*
 * firmware_cpld_get_device_by_minor
 * function: Get device information based on minor
 */
firmware_device_t *firmware_cpld_get_device_by_minor(int minor)
{
...
/**
 * firmware_cpld_device_register
 * function:Registered Driver Device
 * @fw_dev: param[in] Driver information
 * return value:success--FIRMWARE_SUCCESS; fail--FIRMWARE_FAILED
 */
int firmware_cpld_device_register(firmware_device_t *fw_dev)
{
    int ret;
    firmware_device_t *tmp;
...
/**
 * firmware_cpld_device_unregister
 * function: unregister Driver Device
 */
void firmware_cpld_device_unregister(firmware_device_t *fw_dev)
{
