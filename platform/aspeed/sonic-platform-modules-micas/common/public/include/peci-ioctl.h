...
#define PECI_TOOL_DEV_NAME "peci_tool"
#define FULL_PECI_TOOL_PATH     "/dev/"PECI_TOOL_DEV_NAME
...
typedef struct peci_tool_info_s {
    uint32_t controller_id;
    uint32_t addr;
    int cmd_ret;
    int msg_len;
    union {
        struct peci_xfer_msg xfer;
        struct peci_ping_msg ping;
        struct peci_get_dib_msg dib;
        struct peci_get_temp_msg temp;
        struct peci_rd_pkg_cfg_msg rd_pkg_cfg;
        struct peci_wr_pkg_cfg_msg wr_pkg_cfg;
        struct peci_rd_ia_msr_msg rd_ia_msr;
        struct peci_wr_ia_msr_msg wr_ia_msr;
        struct peci_rd_ia_msrex_msg rd_ia_msrex;
        struct peci_rd_pci_cfg_msg rd_pci_cfg;
        struct peci_wr_pci_cfg_msg wr_pci_cfg;
        struct peci_rd_pci_cfg_local_msg rd_pci_cfg_local;
        struct peci_wr_pci_cfg_local_msg wr_pci_cfg_local;
        struct peci_rd_end_pt_cfg_msg rd_end_pt_cfg;
        struct peci_wr_end_pt_cfg_msg wr_end_pt_cfg;
        struct peci_crashdump_disc_msg crashdump_disc;
        struct peci_crashdump_get_frame_msg crashdump_get_frame;
    } cmd_info;
} peci_tool_info_t;
...
#define PECI_IOC_XFER \
    _IOWR(PECI_IOC_BASE, PECI_CMD_XFER, peci_tool_info_t)

#define PECI_IOC_PING \
    _IOWR(PECI_IOC_BASE, PECI_CMD_PING, peci_tool_info_t)

#define PECI_IOC_GET_DIB \
    _IOWR(PECI_IOC_BASE, PECI_CMD_GET_DIB, peci_tool_info_t)

#define PECI_IOC_GET_TEMP \
    _IOWR(PECI_IOC_BASE, PECI_CMD_GET_TEMP, peci_tool_info_t)

#define PECI_IOC_RD_PKG_CFG \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_PKG_CFG, peci_tool_info_t)

#define PECI_IOC_WR_PKG_CFG \
    _IOWR(PECI_IOC_BASE, PECI_CMD_WR_PKG_CFG, peci_tool_info_t)

#define PECI_IOC_RD_IA_MSR \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_IA_MSR, peci_tool_info_t)

#define PECI_IOC_WR_IA_MSR \
    _IOWR(PECI_IOC_BASE, PECI_CMD_WR_IA_MSR, peci_tool_info_t)

#define PECI_IOC_RD_IA_MSREX \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_IA_MSREX, peci_tool_info_t)

#define PECI_IOC_RD_PCI_CFG \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_PCI_CFG, peci_tool_info_t)

#define PECI_IOC_WR_PCI_CFG \
    _IOWR(PECI_IOC_BASE, PECI_CMD_WR_PCI_CFG, peci_tool_info_t)

#define PECI_IOC_RD_PCI_CFG_LOCAL \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_PCI_CFG_LOCAL, peci_tool_info_t)

#define PECI_IOC_WR_PCI_CFG_LOCAL \
    _IOWR(PECI_IOC_BASE, PECI_CMD_WR_PCI_CFG_LOCAL, peci_tool_info_t)

#define PECI_IOC_RD_END_PT_CFG \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_END_PT_CFG, peci_tool_info_t)

#define PECI_IOC_WR_END_PT_CFG \
    _IOWR(PECI_IOC_BASE, PECI_CMD_WR_END_PT_CFG, peci_tool_info_t)

#define PECI_IOC_CRASHDUMP_DISC \
    _IOWR(PECI_IOC_BASE, PECI_CMD_CRASHDUMP_DISC, peci_tool_info_t)

#define PECI_IOC_CRASHDUMP_GET_FRAME \
    _IOWR(PECI_IOC_BASE, PECI_CMD_CRASHDUMP_GET_FRAME, peci_tool_info_t)
