...
from public.platform_common_config import CONFIG_FILE_PATH
...
boardid_subver_configfile = (board_id + "_" + sub_ver + "_config")  # board_id + sub_ver
boardid_configfile = (board_id + "_config")  # board_id

# bmc use _platform_config
platform_config_file_bmc = (platform + "_platform_config")
common_productfile = "platform_default_config"


configfile_pre = CONFIG_FILE_PATH
...
PLATFORM_GLOBALCONFIG = {
    "S3IP_SOFT_LINK": getattr(module_product, "S3IP_SOFT_LINK", []),
    "DRIVERLISTS": getattr(module_product, "DRIVERLISTS", []),
    "OPTOE": getattr(module_product, "OPTOE", []),
    "DEVS": getattr(module_product, "DEVICE", []),
    "BLACKLIST_DRIVERS": getattr(module_product, "BLACKLIST_DRIVERS", []),
    "DRIVERLISTS_CHECK": getattr(module_product, "DRIVERLISTS_CHECK", []),
}
