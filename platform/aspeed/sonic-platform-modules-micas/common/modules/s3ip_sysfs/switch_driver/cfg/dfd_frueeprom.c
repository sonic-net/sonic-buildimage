...
static int dfd_set_fru_product_info(ipmi_product_info_t *ipmi_product_info, ipmi_fru_field_t *vpd_info, int type)
{
    ...
    case DFD_DEV_INFO_TYPE_EXTRA4:
        ...
        break;
    case DFD_DEV_INFO_TYPE_EXTRA5:
        ipmi_product_info->product_extra5 = vpd_info;
        break;
    case DFD_DEV_INFO_TYPE_EXTRA6:
        ipmi_product_info->product_extra6 = vpd_info;
        break;
    case DFD_DEV_INFO_TYPE_EXTRA7:
        ipmi_product_info->product_extra7 = vpd_info;
        break;
    default:
        ret = -1;
        break;
