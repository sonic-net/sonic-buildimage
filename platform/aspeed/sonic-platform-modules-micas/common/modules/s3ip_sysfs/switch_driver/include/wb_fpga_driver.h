 ...
 *       : Failed: A negative value is returned
 */
ssize_t dfd_get_fpga_selftest_status(unsigned int main_dev_id, unsigned int cpld_index, char *buf, size_t count);
...
/**
 * dfd_get_fpga_cram_status - Obtain the FPGA cram status
 * @main_dev_id: Motherboard :0 Subcard :5
 * @index:The number of the FPGA starts from 0
 * @buf: Receive buf
 * @count: Accept the buf length
