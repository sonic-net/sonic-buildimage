...
#define PSU_NOT_MATCH_STR       "1"
#define PSU_MATCH_STR           "0"
extern dfd_debug_data_key_map_t psu_status_dbg_key_table[DFD_PSU_STATUS_END];
extern dfd_debug_data_key_map_t psu_sensor_dbg_key_table[PSU_SENSOR_TYPE_END];
/**
