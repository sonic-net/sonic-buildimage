...
extern ssize_t psu_debug_present_get(char *buf);
extern ssize_t psu_debug_present_set(const char* buf, size_t count);
#define SINGLE_PSU_PRESENT_DEBUG_FILE       WB_HOST_MISC_DIR ".present_psu_%d"
