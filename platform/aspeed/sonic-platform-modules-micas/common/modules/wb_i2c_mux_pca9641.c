...
static int pca9641_setmuxflag(int nr, int flag)
{
	if (pca_flag.nr == nr) {
	    pca_flag.flag = flag;
        return 0;
...
static int pca9641_select_chan_single(struct i2c_mux_core *muxc, u32 chan)
{
	struct pca9541 *data = i2c_mux_priv(muxc);
    struct i2c_client *client = data->client;
    int ret;
...
#endif
{
    ...
    int ret = -ENODEV;
    int detect_id;
    int (*setmuxflag_register_func)(void*);
    i2c_mux_pca9641_device_t *i2c_mux_pca9641_device;
    ...
    setmuxflag_register_func = (void *)kallsyms_lookup_name_fun("setmuxflag_register");
    if (setmuxflag_register_func != NULL) {
        setmuxflag_register_func(pca9641_setmuxflag);
        DEBUG_VERBOSE("pca9641 setmuxflag_register.\n");
    }
...
{
	struct i2c_mux_core *muxc = i2c_get_clientdata(client);
    void (*setmuxflag_unregister_func)(void);

    setmuxflag_unregister_func = (void *)kallsyms_lookup_name_fun("setmuxflag_unregister");
    if (setmuxflag_unregister_func != NULL) {
        setmuxflag_unregister_func();
        DEBUG_VERBOSE("pca9641 setmuxflag_unregister.\n");
    }
