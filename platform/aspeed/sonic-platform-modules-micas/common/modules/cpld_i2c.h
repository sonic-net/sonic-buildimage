...
#define CPLD_I2C_EXT_9548_ADDR        (0x00)
#define CPLD_I2C_EXT_9548_CHAN        (0x04)
#define CPLD_I2C_DEV_SLAVE_ADDR       (0x08)
#define CPLD_I2C_DEV_REG_ADDR         (0x0C)
#define CPLD_I2C_DEV_RDWR_LEN         (0x10)
#define CPLD_I2C_CTRL_REG             (0x14)
#define CPLD_I2C_STATUS_REG           (0x18)
#define CPLD_I2C_SCALE_REG            (0x1C)
#define CPLD_I2C_FILTER_REG           (0x20)
#define CPLD_I2C_STRETCH_REG          (0x24)
#define CPLD_I2C_EXT_9548_EXITS_FLAG  (0x28)
#define CPLD_I2C_INTERNAL_9548_CHAN   (0x2C)
#define CPLD_I2C_RDWR_DATA_BUF        (0x80)
#endif
#define CPLD_I2C_RDWR_MAX_LEN_DEFAULT (128)
#define I2C_REG_MAX_WIDTH             (16)

#define DEV_NAME_MAX_LEN              (64)

#define CPLD_I2C_MAX_TIMES            (10)
#define CPLD_I2C_XFER_TIME_OUT        (100000)
#define CPLD_I2C_SLEEP_TIME           (40)

#define CPLD_I2C_CTL_RD                 (0x01)
#define CPLD_I2C_CTL_WR                 (0x00)
#define CPLD_I2C_CTL_BG                 (0x01 << 1)

typedef struct cpld_i2c_reg_s {
    uint32_t i2c_scale;
    uint32_t i2c_filter;
...
typedef struct cpld_i2c_reset_cfg_s {
...
} cpld_i2c_reset_cfg_t;

typedef struct cpld_i2c_reg_addr_s {
    uint8_t reg_addr_len;
    uint8_t read_reg_addr[I2C_REG_MAX_WIDTH];
} cpld_i2c_reg_addr_t;

typedef struct cpld_i2c_dev_s {
...
typedef struct cpld_i2c_bus_device_s {
    int i2c_timeout;
    int i2c_scale;
    int i2c_filter;
    int i2c_stretch;
    ...
    int i2c_offset_reg;
} cpld_i2c_bus_device_t;

typedef struct cpld_pca954x_device_s {
