...
static const struct platform_device_id ntc_thermistor_id[] = {
	...
	[NTC_COM_10K3977]     = { "common_10k3397",  TYPE_COM_10K3977 },
	[NTC_LAST]            = { },
};
...
static const struct ntc_compensation common_10k3397[] = {
    { .temp_c = -10, .ohm = 54790 },
    { .temp_c = -9,  .ohm = 50770 },
    { .temp_c = -8,  .ohm = 49220 },
    { .temp_c = -7,  .ohm = 46680 },
...
static const struct ntc_type ntc_type[] = {
	...
	NTC_TYPE(TYPE_COM_10K3977,  common_10k3397),
};
...
static const struct of_device_id ntc_match[] = {
	...
	{ .compatible = "ntc,common_10k3397",
		.data = &ntc_thermistor_id[NTC_COM_10K3977] },
