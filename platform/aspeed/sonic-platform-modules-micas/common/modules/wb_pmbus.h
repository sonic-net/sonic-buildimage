...
typedef enum {
    PMBUS_BUS_STATUS_OK        = 0x00,
    PMBUS_BUS_STATUS_ABNORMAL  = 0x01,
} pmbus_bus_status_t;
...
/* !!!Note: If add a new device_name, you also need to add in vr_fw_upg.py */
pmbus_dev_info_t pmbus_dev_infos[] = {
    ...
    {.device_name = "wb_raa228228", .chip_name = "RAA22962048", .device_id = {0x00, 0x9B, 0xD2, 0x49}, .dev_id_len = 4},
    ...
    {.device_name = "wb_isl69260", .chip_name = "ISL69260", .device_id = {0x00, 0x6e, 0xd2, 0x49}, .dev_id_len = 4},
};
