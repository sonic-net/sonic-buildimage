...
static int minor_to_dev(int minor, struct platform_i2c_dev_info **i2c_dev)
{
    int i;
...
static int add_dev_to_g_dev_list(struct platform_i2c_dev_info *i2c_dev)
{
    int i;
    unsigned long flags;
...
static int of_platform_i2c_dev_config_init(struct platform_device *pdev, struct platform_i2c_dev_info *i2c_dev)
{
    ...
    ret = of_dev_status_check_config_init(&pdev->dev, &i2c_dev->status_check, i2c_dev->data_bus_width,
                                            platform_i2c_device_func_read, platform_i2c_device_func_write, i2c_dev->name);
    if (ret != 0) {
...
static int platform_i2c_dev_config_init(struct platform_device *pdev, struct platform_i2c_dev_info *i2c_dev)
{
    ...
    ret = platform_dev_status_check_config_init(&pdev->dev, &i2c_dev->status_check, i2c_dev->data_bus_width, &platform_i2c_dev_device->status_check,
                                        platform_i2c_device_func_read, platform_i2c_device_func_write, i2c_dev->name);
    if (ret != 0) {
