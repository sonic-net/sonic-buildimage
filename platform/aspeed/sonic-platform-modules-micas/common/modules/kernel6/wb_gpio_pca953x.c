...
#define PCA953X_GPIO_BASE_PROP	"gpio-base"
#define PCA953X_GPIO_BASE_LEGACY_PROP	"linux,gpio-base"
...
static void pca953x_get_fw_gpio_base(struct device *dev,
				 struct pca953x_chip *chip)
{
	u32 gpio_base;

	if (!device_property_read_u32(dev, PCA953X_GPIO_BASE_PROP, &gpio_base) ||
	    !device_property_read_u32(dev, PCA953X_GPIO_BASE_LEGACY_PROP,
				       &gpio_base)) {
		chip->gpio_start = gpio_base;
		dev_info(dev, "use fixed gpio base %u from firmware\n", gpio_base);
	}
}
...
static int pca953x_probe(struct i2c_client *client)
{
	...
	if (pdata) {
		...
		pca953x_get_fw_gpio_base(dev, chip);
	}
...
static const struct of_device_id pca953x_dt_ids[] = {
	{ .compatible = "wb_pca6408", .data = OF_953X(8, PCA_INT), },
	{ .compatible = "wb_pca6416", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_pca9505", .data = OF_953X(40, PCA_INT), },
	{ .compatible = "wb_pca9506", .data = OF_953X(40, PCA_INT), },
	{ .compatible = "wb_pca9534", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_pca9535", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_pca9536", .data = OF_953X( 4, 0), },
	{ .compatible = "wb_pca9537", .data = OF_953X( 4, PCA_INT), },
	{ .compatible = "wb_pca9538", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_pca9539", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_pca9554", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_pca9555", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_pca9556", .data = OF_953X( 8, 0), },
	{ .compatible = "wb_pca9557", .data = OF_953X( 8, 0), },
	{ .compatible = "wb_pca9574", .data = OF_957X( 8, PCA_INT), },
	{ .compatible = "wb_pca9575", .data = OF_957X(16, PCA_INT), },
	{ .compatible = "wb_pca9698", .data = OF_953X(40, 0), },

	{ .compatible = "wb_pcal6408", .data = OF_953X(8, PCA_LATCH_INT), },
	{ .compatible = "wb_pcal6416", .data = OF_953X(16, PCA_LATCH_INT), },
	{ .compatible = "wb_pcal6524", .data = OF_953X(24, PCA_LATCH_INT), },
	{ .compatible = "wb_pcal6534", .data = OF_653X(34, PCA_LATCH_INT), },
	{ .compatible = "wb_pcal9535", .data = OF_953X(16, PCA_LATCH_INT), },
	{ .compatible = "wb_pcal9554b", .data = OF_953X( 8, PCA_LATCH_INT), },
	{ .compatible = "wb_pcal9555a", .data = OF_953X(16, PCA_LATCH_INT), },

	{ .compatible = "wb_max7310", .data = OF_953X( 8, 0), },
	{ .compatible = "wb_max7312", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_max7313", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_max7315", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_max7318", .data = OF_953X(16, PCA_INT), },

	{ .compatible = "wb_pca6107", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_pca9536", .data = OF_953X( 4, 0), },
	{ .compatible = "wb_tca6408", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_tca6416", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_tca6424", .data = OF_953X(24, PCA_INT), },
	{ .compatible = "wb_tca9535", .data = OF_953X(16, PCA_INT), },
	{ .compatible = "wb_tca9538", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_tca9539", .data = OF_953X(16, PCA_INT), },

	{ .compatible = "wb_cat9554", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_pca9654", .data = OF_953X( 8, PCA_INT), },
	{ .compatible = "wb_pca9655", .data = OF_953X(16, PCA_INT), },

	{ .compatible = "wb_xra1202", .data = OF_953X( 8, 0), },
	{ }
};
