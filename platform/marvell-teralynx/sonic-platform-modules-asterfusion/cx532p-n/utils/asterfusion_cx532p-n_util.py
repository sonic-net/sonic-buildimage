...
kos = [
    'depmod -a',
    'modprobe i2c_dev',
    'modprobe x86-64-asterfusion-cx532p-n',
    'modprobe nct7511',
    'modprobe at24_smbus',
    'modprobe at24',
    'modprobe zrh2800k2',
...
def set_led_control():
    cmd = "echo 1 > /sys/class/hwmon/hwmon2/device/CX532P_LED/led_fiber"
    status, output = log_os_system(cmd, 1)
    if status:
        print(output)
...
def bmc_is_exist():
    value = ''
    bmc_filePath = '/sys/class/hwmon/hwmon2/device/CX532P_SYS/bmc_presnet'
