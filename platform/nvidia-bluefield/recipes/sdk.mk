...
$(DOCA_COMMON)_RDEPENDS = $(DPDK) $(RXPCOMPILER) $(LIBRXPCOMPILER_DEV) $(LIBGRPC_DEV) $(FLEXIO)
$(DOCA_COMMON)_DEPENDS = $(RXPCOMPILER) $(LIBRXPCOMPILER_DEV) $(DPDK_DEV) $(LIBGRPC_DEV) $(FLEXIO)

DOCA_COMMON_DEV = libdoca-sdk-common-dev_${DOCA_DEB_VERSION}_${CONFIGURED_ARCH}.deb
DOCA_COMMON_DBG = doca-sdk-common-dbgsym_${DOCA_DEB_VERSION}_${CONFIGURED_ARCH}.deb
...
DOCA_ARGP_DBG = doca-sdk-argp-dbgsym_${DOCA_DEB_VERSION}_${CONFIGURED_ARCH}.deb
...
DOCA_DPDK_BRIDGE_DBG = doca-sdk-dpdk-bridge-dbgsym_${DOCA_DEB_VERSION}_${CONFIGURED_ARCH}.deb
...
DOCA_DBG_DEBS += $(DOCA_DPDK_BRIDGE_DBG)
...
DOCA_FLOW_DBG = doca-sdk-flow-dbgsym_${DOCA_DEB_VERSION}_${CONFIGURED_ARCH}.deb
...
export DOCA_DEBS DOCA_DEV_DEBS DOCA_DBG_DEBS
...
$(SDN_APPL)_RDEPENDS = $(DOCA_COMMON) $(DOCA_DEBS) $(FLEXIO) $(MLNX_TOOLS) $(OFED_KERNEL_UTILS) $(MLNX_IPROUTE2)
$(SDN_APPL)_DEPENDS = $(DOCA_COMMON) $(DOCA_DEBS) $(DOCA_DEV_DEBS) $(DPDK_DEV) $(FLEXIO) $(MLNX_TOOLS) $(OFED_KERNEL_UTILS)
