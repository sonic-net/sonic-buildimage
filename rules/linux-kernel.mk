...
LINUX_KBUILD = linux-kbuild-$(KVERSION)_$(KERNEL_VERSION)-$(KERNEL_SUBVERSION)_$(CONFIGURED_ARCH).deb
...
$(LINUX_HEADERS)_DEPENDS += $(LINUX_KBUILD)
$(LINUX_HEADERS)_RDEPENDS += $(LINUX_KBUILD)
