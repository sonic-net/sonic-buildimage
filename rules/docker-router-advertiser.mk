...
$(DOCKER_ROUTER_ADVERTISER)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_DEPENDS)

$(DOCKER_ROUTER_ADVERTISER)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_IMAGE_PACKAGES)

$(DOCKER_ROUTER_ADVERTISER)_LOAD_DOCKERS = $(DOCKER_CONFIG_ENGINE_TRIXIE)
...
SONIC_TRIXIE_DOCKERS += $(DOCKER_ROUTER_ADVERTISER)
SONIC_TRIXIE_DBG_DOCKERS += $(DOCKER_ROUTER_ADVERTISER_DBG)
...
$(DOCKER_ROUTER_ADVERTISER)_RUN_OPT += -v /var/run/gnmi:/var/run/gnmi:ro
