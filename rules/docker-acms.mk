...
$(DOCKER_ACMS)_PYTHON_WHEELS += $(SONIC_PY_COMMON_PY3) $(SWSSSDK_PY3) $(SONIC_ACMS_PY3)
$(DOCKER_ACMS)_DEPENDS += $(LIBSWSSCOMMON) $(PYTHON3_SWSSCOMMON) $(ACMS_CLIENT)
$(DOCKER_ACMS)_LOAD_DOCKERS = $(DOCKER_CONFIG_ENGINE_BOOKWORM)
