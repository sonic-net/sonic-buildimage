...
$(DOCKER_DHCP_SERVER)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_DEPENDS)

$(DOCKER_DHCP_SERVER)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_IMAGE_PACKAGES)

$(DOCKER_DHCP_SERVER)_LOAD_DOCKERS = $(DOCKER_CONFIG_ENGINE_TRIXIE)
...
SONIC_TRIXIE_DOCKERS += $(DOCKER_DHCP_SERVER)
SONIC_DOCKER_DBG_IMAGES += $(DOCKER_DHCP_SERVER_DBG)
SONIC_TRIXIE_DBG_DOCKERS += $(DOCKER_DHCP_SERVER_DBG)
...
$(DOCKER_DHCP_SERVER)_CONTAINER_VOLUMES += /var/lib/kea:/var/lib/kea:rw
