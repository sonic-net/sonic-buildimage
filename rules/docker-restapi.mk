...
$(DOCKER_RESTAPI)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_RESOLUTE)_DBG_DEPENDS)
$(DOCKER_RESTAPI)_DBG_DEPENDS += $(RESTAPI_DBG)

$(DOCKER_RESTAPI)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_RESOLUTE)_DBG_IMAGE_PACKAGES)

$(DOCKER_RESTAPI)_PATH = $(DOCKERS_PATH)/$(DOCKER_RESTAPI_STEM)

$(DOCKER_RESTAPI)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_RESOLUTE)
