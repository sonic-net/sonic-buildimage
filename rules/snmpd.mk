...
ifeq ($(BLDENV),trixie)
LIBNETSNMPTRAPD = libnetsnmptrapd40t64_$(SNMPD_VERSION_FULL)_$(CONFIGURED_ARCH).deb
else
LIBNETSNMPTRAPD = libnetsnmptrapd40_$(SNMPD_VERSION_FULL)_$(CONFIGURED_ARCH).deb
endif
$(LIBNETSNMPTRAPD)_RDEPENDS += $(LIBSNMP_BASE)
$(eval $(call add_derived_package,$(LIBSNMP_BASE),$(LIBNETSNMPTRAPD)))

ifeq ($(BLDENV),trixie)
LIBNETSNMPTRAPD_DBG = libnetsnmptrapd40t64-dbgsym_$(SNMPD_VERSION_FULL)_$(CONFIGURED_ARCH).deb
else
LIBNETSNMPTRAPD_DBG = libnetsnmptrapd40-dbgsym_$(SNMPD_VERSION_FULL)_$(CONFIGURED_ARCH).deb
endif
$(LIBNETSNMPTRAPD_DBG)_DEPENDS += $(LIBNETSNMPTRAPD)
$(LIBNETSNMPTRAPD_DBG)_RDEPENDS += $(LIBNETSNMPTRAPD)
$(eval $(call add_derived_package,$(LIBSNMP_BASE),$(LIBNETSNMPTRAPD_DBG)))

LIBSNMP_DEV = libsnmp-dev_$(SNMPD_VERSION_FULL)_$(CONFIGURED_ARCH).deb
$(LIBSNMP_DEV)_DEPENDS += $(LIBSNMP) $(LIBNETSNMPTRAPD)
