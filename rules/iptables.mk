...
$(eval $(call add_derived_package,$(IPTABLESIP4TC),$(LIBIP4TC_DBG)))
...
$(eval $(call add_derived_package,$(IPTABLESIP6TC),$(LIBIP6TC_DBG)))
...
$(eval $(call add_derived_package,$(IPXTABLES12),$(LIBXTABLES_DBG)))
