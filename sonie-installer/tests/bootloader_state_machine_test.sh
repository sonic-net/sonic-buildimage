#!/bin/bash
#
# Tests for bootloader_state_machine.grub.
#
# Usage:
#   ./bootloader_state_machine_test.sh

# We do not use set -u because bootloader_state_machine.grub treats unset variables
...
# shellcheck source=bootloader_state_machine.grub
