...
class TestJ2Files(TestCase):
    def setUp(self):
        ...
        self.t0_minigraph_no_vlan_ipv4 = os.path.join(self.test_dir, 't0-sample-graph-no-vlan-ipv4.xml')
    ...
    def test_dhcp_relay(self):
        ...
        argument = ['-m', self.t0_minigraph_no_vlan_ipv4, '-p', self.t0_port_config, '-t', template_path]
        self.run_script(argument, output_file=self.output_file)
