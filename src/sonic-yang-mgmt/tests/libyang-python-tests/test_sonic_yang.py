...
class Test_SonicYang(object):
    ...
    def test_validate_yang_models(self, sonic_yang_data):
        ...
        # Helper YANG files are not ConfigDB tables and do not appear in xlateJson:
        # sonic-extension.yang, sonic-types.yang, sonic-bgp-common.yang,
        # sonic-event.yang, sonic-alarm.yang, sonic-common.yang.
        ...
        NON_CONFIG_YANG_FILES = 7 + EVENT_YANG_FILES
        # read config
