...
class Test_SonicYang(object):
    ...
    def test_validate_yang_models(self, sonic_yang_data):
        ...
        # Currently only 4 YANG files are not directly related to config, along with event YANG models
        # which are: sonic-extension.yang, sonic-types.yang, sonic-bgp-common.yang and sonic-port-state.yang.
