    ...
    ipv4_pfx_attrs = [
                       {
                         ...
                         "expect": "permit 10.1.1.1/16 ge 18 le 24",
                       },
                       {
                         "args": ('20.2.2.2/24', None, 'deny'),
                         "expect": "deny 10.1.1.1/16",
                       },
                       {
                         "args": ('30.3.3.3/8', '10..32', 'permit'),
                         "expect": "permit 30.3.3.3/8 ge 10 le 32",
                       },
                       {
                         "args": ('40.4.4.4/28', '20..30', 'deny'),
                         "expect": "deny 40.4.4.4/28 ge 20 le 30",
                       },
                       {
                         "args": ('1.2.3.0/28', '20..30', 'deny', 555),
                         "expect": "seq 555 deny 1.2.3.0/28 ge 20 le 30",
                       },
                       {
    ...
    ipv6_pfx_attrs = [
                       {
                         ...
                         "expect": "permit 1000:1::1/64 ge 80 le 120",
                       },
                       {
                         "args": ('2000:2::2/96', None, 'deny'),
                         "expect": "deny 2000:2::2/96",
                       },
                       {
                         "args": ('3000:3::3/32', '40..128', 'permit'),
                         "expect": "permit 3000:3::3/32 ge 40 le 128",
                       },
                       {
                         "args": ('4000:4::4/80', '60..100', 'deny'),
                         "expect": "deny 4000:4::4/80 ge 60 le 100",
                       },
                       {
                         "args": ('5000:5::5/80', '60..100', 'deny', 1234),
                         "expect": "seq 1234 deny 5000:5::5/80 ge 60 le 100",
                       },
                       {
                         "args": ('6000:6::6/80', None, 'permit', 4321),
                         "expect": "seq 4321 permit 6000:6::6/80",
                       },
                     ]
