...
# psid_val, default_pw, tpm_reg, tpm_reg_2 globals (empty is rejected at CLI parse time).
# Populates disk_name and nvme_disk_name on success. Tool availability is enforced upstream by ssd_erase.sh:check_tools.
