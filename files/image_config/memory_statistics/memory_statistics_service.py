...
class MemoryStatisticsProcessor:
    ...
    #     Raises:
    #     - TypeError: If the sampling interval is not an integer.
    #     - ValueError: If the sampling interval is not within the accepted range or is invalid.
    #     """
    #     if not isinstance(interval_minutes, int):
    #         raise TypeError("Sampling interval must be an integer.")
