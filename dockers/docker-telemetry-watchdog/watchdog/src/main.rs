...
const DEFAULT_GOOD_CA: &str = "/etc/sonic/telemetry/dsmsroot.cer";
const DEFAULT_GOOD_CERT: &str = "/etc/sonic/telemetry/streamingtelemetryserver.cer";
const DEFAULT_GOOD_KEY: &str = "/etc/sonic/telemetry/streamingtelemetryserver.key";
const DEFAULT_GOOD_CNAME: &str = "server.ndastreaming.ap.gbl";
                    ...
                    if !telemetry_enabled {
                        ...
                        if http_status == "HTTP/1.1 200 OK" {
                            ...
                            if is_cert_probe_enabled() {
                                ...
                                let mut res_bad = run_gnmi_for_xpath(&xpath_rc, port, &bad_sec, DEFAULT_BAD_CNAME, timeout, "SHOW");
                                if res_bad.success {
                                ...
                                let res_good = run_gnmi_for_xpath(&xpath_rc, port, &good_sec, DEFAULT_GOOD_CNAME, timeout, "SHOW");
