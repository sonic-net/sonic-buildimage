...
// Check acms program status
fn check_acms_status() -> String {

    "OK".to_string()
}

fn main() {
    let watchdog_port = 51001;
    // Start a HTTP server listening on port 51001
    ...
    for stream_result in listener.incoming() {
        match stream_result {
            Ok(mut stream) => {
                ...
                let acms_result      = check_acms_status();
